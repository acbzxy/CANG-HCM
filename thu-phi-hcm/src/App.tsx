...
// Import setup permissions để có thể sử dụng
import "./utils/setupPermissions";
...
const FeeDeclarationManagePage = lazy(
  () => import("./pages/FeeDeclarationManagePage")
);
...
const SummaryByWarehousePage = lazy(
  () => import("./pages/reports/SummaryByWarehousePage")
);
const SummaryByServicePage = lazy(
  () => import("./pages/reports/SummaryByServicePage")
);
const SummaryByEnterprisePage = lazy(
  () => import("./pages/reports/SummaryByEnterprisePage")
);
const DetailedReportPage = lazy(
  () => import("./pages/reports/DetailedReportPage")
);
const ReceiptUsageHistoryPage = lazy(
  () => import("./pages/reports/ReceiptUsageHistoryPage")
);
const CollectionSummaryPage = lazy(
  () => import("./pages/reports/CollectionSummaryPage")
);
const ReceiptLookupDetailPage = lazy(
  () => import("./pages/reports/ReceiptLookupPage")
);

// Debt Management Pages
const DebtManagementPage = lazy(
  () => import("./pages/debt-management/DebtManagementPage")
);
const DebtStatusPage = lazy(
  () => import("./pages/debt-management/DebtStatusPage")
);
const BusinessServicesPage = lazy(
  () => import("./pages/debt-management/BusinessServicesPage")
);
const CreateQRCodePage = lazy(
  () => import("./pages/debt-management/CreateQRCodePage")
);

// Data Reconciliation Pages
const DataReconciliationPage = lazy(
  () => import("./pages/data-reconciliation/DataReconciliationPage")
);
const InitializePage = lazy(
  () => import("./pages/data-reconciliation/InitializePage")
);
...
const PaymentManagementPage = lazy(
  () => import("./pages/payment-management/PaymentManagementPage")
);
      ...
      <NotificationProvider>
        <Suspense fallback={<LoadingSpinner />}>
          <Routes>
            ...
            />
            <Route
              path="/fee-declaration/manage"
              element={
                <ProtectedRoute>
                  <FeeDeclarationManagePage />
                </ProtectedRoute>
              }
            />
            <Route
              path="/fee-declaration/barcode"
              element={
                <ProtectedRoute>
                  <BarcodeFeePage />
                </ProtectedRoute>
            ...
            />
            <Route
              path="/fee-declaration/debt-management"
              element={
                <ProtectedRoute>
                  <DebtManagePage />
                </ProtectedRoute>
            ...
            />
            <Route
              path="/receipt-management/create"
              element={
                <ProtectedRoute>
                  <CreateReceiptPage />
                </ProtectedRoute>
            ...
            />
            <Route
              path="/reports/receipt-lookup"
              element={
                <ProtectedRoute>
                  <ReceiptLookupDetailPage />
                </ProtectedRoute>
              }
            />
            <Route
            ...
            />
            <Route
              path="/payment-management/manage"
              element={
                <ProtectedRoute>
                  <PaymentManagementPage />
                </ProtectedRoute>
            ...
            />
            <Route
              path="/payment-management/cancel"
              element={
                <ProtectedRoute>
                  <PaymentManagementPage />
                </ProtectedRoute>
            ...
            />
            <Route
              path="/payment-management/restore"
              element={
                <ProtectedRoute>
                  <PaymentManagementPage />
                </ProtectedRoute>
