        ...
        >
          ...
          >
            ...
            >
              ...
              >
                KHAI BÁO NỘP PHÍ SỬ DỤNG KẾT CẤU HẠ TẦNG - CÔNG TRÌNH DỊCH VỤ,
                TIỆN ÍCH CÔNG CỘNG
              </p>
            </div>
              ...
              >
                ...
                <div
                  style={{
                    ...
                    borderRadius: "50%",
                    background:
                      "linear-gradient(135deg, rgba(243, 111, 33, 0.08), rgba(255, 140, 66, 0.04))",
                    filter: "blur(20px)",
                    zIndex: -1,
                  }}
                ></div>
                <div
                  style={{
                    ...
                    borderRadius: "50%",
                    background:
                      "linear-gradient(135deg, rgba(13, 177, 75, 0.08), rgba(16, 199, 91, 0.04))",
                    filter: "blur(15px)",
                    zIndex: -1,
                  }}
                ></div>
                ...
                >
                  ...
                  >
                    ...
                    <form onSubmit={handleSubmit}>
                      ...
                      >
                        Mã số thuế
                        <span style={{ fontStyle: "italic" }}>(10 số)</span>
                      </div>
                      <div
                    ...
                    >
                      ...
                      >
                        ...
                        <span>Đăng nhập doanh nghiệp cảng</span>
                      </a>
                  ...
                  >
                    ...
                    <div
                      style={{
                        ...
                        borderRadius: "50%",
                        background:
                          "linear-gradient(135deg, rgba(243, 111, 33, 0.1), rgba(255, 140, 66, 0.05))",
                        filter: "blur(15px)",
                        zIndex: -1,
                      }}
                    ></div>
                    <div
                      style={{
                        ...
                        borderRadius: "50%",
                        background:
                          "linear-gradient(135deg, rgba(13, 177, 75, 0.1), rgba(16, 199, 91, 0.05))",
                        filter: "blur(12px)",
                        zIndex: -1,
                      }}
                    ></div>
                        ...
                        >
                          <div
                            style={{
                              ...
                              borderRadius: "50%",
                              background:
                                "linear-gradient(135deg, #f36f21, #ff8c42)",
                              marginRight: "15px",
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              • Bảo trì hệ thống:{" "}
                              <span
                                style={{ color: "#f36f21", fontWeight: "600" }}
                              >
                                20-22/12/2024
                              </span>
                            </p>
                        ...
                        >
                          <div
                            style={{
                              ...
                              borderRadius: "50%",
                              background:
                                "linear-gradient(135deg, #0db14b, #10c75b)",
                              marginRight: "15px",
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              ...
                              <br />
                              • Video hướng dẫn khai phí ECUS
                              <br />• Hỗ trợ:{" "}
                              <span
                                style={{ color: "#0db14b", fontWeight: "600" }}
                              >
                                1900 1286
                              </span>
                            </div>
                  ...
                  {/* End Right Info Cards Container */}
                </div>{" "}
                {/* End Inner Content Layout */}
              </div>{" "}
              {/* End Unified Main Container */}
            </div>{" "}
          ...
          >
            ...
            <div style={{ padding: "20px" }}>
              ...
              <div style={{ marginBottom: "16px" }}>
                ...
                >
                  <option>
                    KHÔI PHỤC TÀI KHOẢN THÔNG QUA MÃ SỐ THUẾ VÀ EMAIL
                  </option>
                </select>
              </div>
              ...
              >
                Vui lòng điền Mã số thuế và Email đã đăng ký. Hệ thống sẽ gửi
              ...
              <form onSubmit={handleForgotPasswordSubmit}>
                ...
                <div style={{ marginBottom: "16px" }}>
                  ...
                  >
                    Mã số thuế
                    <span style={{ fontStyle: "italic" }}>(12 chữ số)</span>
            ...
            <div style={{ padding: "20px" }}>
              <form onSubmit={handleRegisterSubmit}>
                ...
                >
                  ...
                  <div>
                    ...
                    <div style={{ marginBottom: "16px" }}>
                      ...
                      >
                        Email - Để nhận thông tin từ Cảng vụ{" "}
                        <span style={{ fontStyle: "italic" }}>
                          (Biên lai, thông báo...):
                        </span>
                        <span style={{ color: "#ef4444", marginLeft: "2px" }}>
                ...
                <div style={{ marginBottom: "20px" }}>
                  ...
                  >
                    ...
                    <span>
                      Đăng ký chữ ký số{" "}
                      <span style={{ fontStyle: "italic" }}>
                        (Để thực hiện việc ký số điện tử cho tờ khai nộp phí của
                        doanh nghiệp. Ký số điện tử cho tờ khai phí là bắt
                        buộc.)
                      </span>
                    </span>
                  </label>
                ...
                >
                  ...
                  >
                    - Tổ chức, cá nhân cần cung cấp đầy đủ, chính xác các thông
                    tin theo yêu cầu của Hệ thống khai báo nộp phí. Sau 7 ngày
                    kể từ khi đăng ký tài khoản, các tài khoản không cập nhật
                    đầy đủ thông tin sẽ bị tạm khóa.
                  </div>
                  <div
                    style={{
                      fontSize: "13px",
                  ...
                  >
                    - Mọi thông tin chi tiết xin liên hệ số Tổng đài Hỗ trợ:{" "}
