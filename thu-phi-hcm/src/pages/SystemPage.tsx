...
const SystemPage: React.FC = () => {
  ...
  // State cho modal quản lý quyền user
  const [showUserPermissionModal, setShowUserPermissionModal] = useState(false);
  const [selectedUser, setSelectedUser] = useState<any>(null);
  const [userGroupPermissions, setUserGroupPermissions] = useState<any[]>([]);
  const [userDisabledFeatures, setUserDisabledFeatures] = useState<any[]>([]);

  // State cho danh sách user thực từ database
  ...
  // Load danh sách nhóm người dùng từ backend
  const loadGroups = async () => {
    try {
      const res: any = await CrmApiService.getAllSysGroupUsers();
      ...
      // silently ignore; table sẽ rỗng nếu lỗi
    }
  };

  useEffect(() => {
    loadGroups();
    loadUsers(); // Load danh sách user từ database
  }, []);
  ...
  const [banksList, setBanksList] = useState([
    ...
    },
    {
      ...
      code: "TPB",
      name: "TPBank",
      description: "Ngân hàng TMCP Tiền Phong",
      isActive: false,
    },
    {
      id: 6,
      code: "MSB",
      name: "MSB",
      description: "Ngân hàng TMCP Hàng Hải Việt Nam",
      isActive: true,
    },
    {
      id: 7,
  ...
  const [warehousesList, setWarehousesList] = useState([
    {
      ...
      maHaiQuan: "HQ001",
      maCK: "CK001",
      diaChi: "123 Đường Nguyễn Tất Thành, Q.4, TP.HCM",
      ghiChu: "Kho container chính",
      isActive: true,
    },
    {
      id: 2,
      ...
      maHaiQuan: "HQ002",
      maCK: "CK002",
      diaChi: "456 Đường Đồng Văn Cống, Q.2, TP.HCM",
      ghiChu: "Cảng container quốc tế",
      isActive: true,
    },
    {
      id: 3,
      ...
      maHaiQuan: "HQ003",
      maCK: "CK003",
      diaChi: "789 Đường Nguyễn Hữu Cảnh, Q.Bình Thạnh, TP.HCM",
      ghiChu: "Bãi container nội địa",
      isActive: false,
    },
    {
      id: 4,
      ...
      maHaiQuan: "HQ004",
      maCK: "CK004",
      diaChi: "15 Đường Nguyễn Bình, Q.Nhà Bè, TP.HCM",
      ghiChu: "Cảng sông nội địa",
      isActive: true,
    },
    {
      id: 5,
      ...
      maHaiQuan: "HQ005",
      maCK: "CK005",
      diaChi: "88 Đường Huỳnh Tấn Phát, Q.7, TP.HCM",
      ghiChu: "Kho xuất nhập khẩu",
      isActive: true,
    },
    {
      id: 6,
      code: "WH006",
      name: "Bãi container Đồng Nai",
      maHaiQuan: "HQ006",
      maCK: "CK006",
      diaChi: "252 Đường Quốc lộ 1A, Biên Hòa, Đồng Nai",
      ghiChu: "Bãi trung chuyển hàng hóa",
      isActive: true,
    },
    {
      id: 7,
      ...
      maHaiQuan: "HQ007",
      maCK: "CK007",
      diaChi: "77 Đường Lê Duẩn, TP.Bà Rịa, BR-VT",
      ghiChu: "Cảng biển Bà Rịa - Vũng Tàu",
      isActive: true,
    },
    {
      id: 8,
      ...
      maHaiQuan: "HQ008",
      maCK: "CK008",
      diaChi: "333 Đường Xa lộ Hà Nội, Q.2, TP.HCM",
      ghiChu: "Kho hàng nông sản",
      isActive: false,
    },
    {
      id: 9,
      ...
      maHaiQuan: "HQ009",
      maCK: "CK009",
      diaChi: "144 Đường Nguyễn Tất Thành, Q.4, TP.HCM",
      ghiChu: "Bãi container Tân Cảng",
      isActive: true,
    },
    {
      id: 10,
      ...
      maHaiQuan: "HQ010",
      maCK: "CK010",
      diaChi: "666 Đường Hùng Vương, TP.Tân An, Long An",
      ghiChu: "Cảng sông Long An",
      isActive: true,
    },
    {
      id: 11,
      ...
      maHaiQuan: "HQ011",
      maCK: "CK011",
      diaChi: "555 Đường Mai Chí Thọ, Q.2, TP.HCM",
      ghiChu: "Kho logistics Phú Hữu",
      isActive: true,
    },
    {
      id: 12,
      ...
      maHaiQuan: "HQ012",
      maCK: "CK012",
      diaChi: "999 Đường Tỉnh lộ 15, Gò Dầu, Tây Ninh",
      ghiChu: "Bãi hàng hóa biên giới",
      isActive: false,
    },
    {
      id: 13,
      ...
      maHaiQuan: "HQ013",
      maCK: "CK013",
      diaChi: "321 Đường 3/2, Q.Ninh Kiều, Cần Thơ",
      ghiChu: "Cảng sông miền Tây",
      isActive: true,
    },
    {
      id: 14,
      ...
      maHaiQuan: "HQ014",
      maCK: "CK014",
      diaChi: "147 Đường Mỹ Phước Tân Vạn, Bến Cát, Bình Dương",
      ghiChu: "Kho công nghiệp",
      isActive: true,
    },
    {
      id: 15,
      ...
      maHaiQuan: "HQ015",
      maCK: "CK015",
      diaChi: "258 Đường Võ Văn Ngân, TP.Thủ Đức, TP.HCM",
      ghiChu: "Bãi tập kết hàng hóa",
      isActive: true,
    },
  ]);
  ...
  const [tollStationsList, setTollStationsList] = useState([
    {
      ...
      name: "Trạm Thu Đức",
      maSoThue: "0312345001",
      diaChi: "123 Đường Võ Văn Ngân, TP.Thủ Đức, TP.HCM",
      tenGiaoDich: "Thu phí Quốc lộ 1A",
      isActive: true,
    },
    {
      id: 2,
      ...
      maSoThue: "0312345002",
      diaChi: "456 Đường Hanoi Highway, Q.Bình Thạnh, TP.HCM",
      tenGiaoDich: "Thu phí Xa lộ Hà Nội",
      isActive: true,
    },
    {
      id: 3,
      ...
      name: "Trạm An Sương",
      maSoThue: "0312345003",
      diaChi: "789 Đường Quốc lộ 22, Q.12, TP.HCM",
      tenGiaoDich: "Thu phí Quốc lộ 22",
      isActive: false,
    },
    {
      id: 4,
      ...
      maSoThue: "0312345004",
      diaChi: "147 Đường Võ Văn Vân, H.Bình Chánh, TP.HCM",
      tenGiaoDich: "Thu phí Vành đai 3",
      isActive: true,
    },
    {
      id: 5,
      ...
      name: "Trạm Nhà Bè",
      maSoThue: "0312345005",
      diaChi: "258 Đường Nguyễn Bình, Q.Nhà Bè, TP.HCM",
      tenGiaoDich: "Thu phí cầu Phú Mỹ",
      isActive: true,
    },
    {
      id: 6,
      ...
      maSoThue: "0312345006",
      diaChi: "369 Đường Quốc lộ 51, H.Long Thành, Đồng Nai",
      tenGiaoDich: "Thu phí cao tốc Long Thành",
      isActive: true,
    },
    {
      id: 7,
      ...
      name: "Trạm Dầu Giây",
      maSoThue: "0312345007",
      diaChi: "741 Đường Quốc lộ 1A, H.Thống Nhất, Đồng Nai",
      tenGiaoDich: "Thu phí Dầu Giây",
      isActive: true,
    },
    {
      id: 8,
      code: "TTP008",
      name: "Trạm Phan Thiết",
      maSoThue: "0312345008",
      diaChi: "852 Đường Quốc lộ 1A, TP.Phan Thiết, Bình Thuận",
      tenGiaoDich: "Thu phí Phan Thiết",
      isActive: false,
    },
    {
      id: 9,
      ...
      name: "Trạm Cần Thơ",
      maSoThue: "0312345009",
      diaChi: "963 Đường Quốc lộ 1A, Q.Cái Răng, Cần Thơ",
      tenGiaoDich: "Thu phí cầu Cần Thơ",
      isActive: true,
    },
    {
      id: 10,
      ...
      name: "Trạm An Giang",
      maSoThue: "0312345010",
      diaChi: "159 Đường Quốc lộ 80, TP.Long Xuyên, An Giang",
      tenGiaoDich: "Thu phí Quốc lộ 80",
      isActive: true,
    },
    {
      id: 11,
      ...
      name: "Trạm Tây Ninh",
      maSoThue: "0312345011",
      diaChi: "357 Đường Quốc lộ 22, TP.Tây Ninh, Tây Ninh",
      tenGiaoDich: "Thu phí biên giới Tây Ninh",
      isActive: true,
    },
    {
      id: 12,
      ...
      name: "Trạm Bà Rịa",
      maSoThue: "0312345012",
      diaChi: "468 Đường Quốc lộ 51, TP.Bà Rịa, BR-VT",
      tenGiaoDich: "Thu phí Bà Rịa - Vũng Tàu",
      isActive: false,
    },
    {
      id: 13,
      ...
      name: "Trạm Đồng Nai",
      maSoThue: "0312345013",
      diaChi: "579 Đường Võ Nguyên Giáp, TP.Biên Hòa, Đồng Nai",
      tenGiaoDich: "Thu phí Biên Hòa",
      isActive: true,
    },
    {
      id: 14,
      ...
      maSoThue: "0312345014",
      diaChi: "680 Đường Mỹ Phước Tân Vạn, TP.Thủ Dầu Một, Bình Dương",
      tenGiaoDich: "Thu phí Bình Dương",
      isActive: true,
    },
    {
      id: 15,
      ...
      name: "Trạm Long An",
      maSoThue: "0312345015",
      diaChi: "791 Đường Hùng Vương, TP.Tân An, Long An",
      tenGiaoDich: "Thu phí Long An",
      isActive: true,
    },
  ]);
  ...
  const [storageLocationsList, setStorageLocationsList] = useState([
    {
      ...
      dienGiai: "Kho lưu trữ trung tâm",
      loai: "Trung tâm",
      isActive: true,
    },
    {
      ...
      name: "Kho Quận 7",
      tenKhac: "Kho Q7",
      diaChi: "456 Đường Nguyễn Thị Thập, Q.7, TP.HCM",
      dienGiai: "Kho lưu trữ phụ",
      loai: "Phụ trợ",
      isActive: true,
    },
    {
      ...
      name: "Kho Thủ Đức",
      tenKhac: "Kho TD",
      diaChi: "789 Đường Võ Văn Ngân, TP.Thủ Đức, TP.HCM",
      dienGiai: "Kho công nghiệp",
      loai: "Công nghiệp",
      isActive: false,
    },
    {
      ...
      name: "Kho Bình Thạnh",
      tenKhac: "Kho BT",
      diaChi: "147 Đường Xô Viết Nghệ Tĩnh, Q.Bình Thạnh, TP.HCM",
      dienGiai: "Kho lưu trữ tạm thời",
      loai: "Tạm thời",
      isActive: true,
    },
    {
      ...
      name: "Kho Gò Vấp",
      tenKhac: "Kho GV",
      diaChi: "258 Đường Phan Văn Trị, Q.Gò Vấp, TP.HCM",
      dienGiai: "Kho phân phối",
      loai: "Phân phối",
      isActive: true,
    },
    {
      ...
      name: "Kho Tân Bình",
      tenKhac: "Kho TB",
      diaChi: "369 Đường Hoàng Văn Thụ, Q.Tân Bình, TP.HCM",
      dienGiai: "Kho gần sân bay",
      loai: "Sân bay",
      isActive: true,
    },
    {
      ...
      name: "Kho Quận 12",
      tenKhac: "Kho Q12",
      diaChi: "741 Đường Quốc lộ 22, Q.12, TP.HCM",
      dienGiai: "Kho biên giới",
      loai: "Biên giới",
      isActive: true,
    },
    {
      ...
      name: "Kho Bình Chánh",
      tenKhac: "Kho BC",
      diaChi: "852 Đường Võ Văn Vân, H.Bình Chánh, TP.HCM",
      dienGiai: "Kho ngoại ô",
      loai: "Ngoại ô",
      isActive: false,
    },
    {
      ...
      name: "Kho Nhà Bè",
      tenKhac: "Kho NB",
      diaChi: "963 Đường Nguyễn Bình, Q.Nhà Bè, TP.HCM",
      dienGiai: "Kho cảng sông",
      loai: "Cảng sông",
      isActive: true,
    },
    {
      ...
      name: "Kho Cần Giờ",
      tenKhac: "Kho CG",
      diaChi: "159 Đường Trần Hưng Đạo, H.Cần Giờ, TP.HCM",
      dienGiai: "Kho ven biển",
      loai: "Ven biển",
      isActive: true,
    },
    {
      ...
      name: "Kho Củ Chi",
      tenKhac: "Kho CC",
      diaChi: "357 Đường Tỉnh lộ 15, H.Củ Chi, TP.HCM",
      dienGiai: "Kho nông nghiệp",
      loai: "Nông nghiệp",
      isActive: true,
    },
    {
      ...
      name: "Kho Hóc Môn",
      tenKhac: "Kho HM",
      diaChi: "468 Đường Quốc lộ 22, H.Hóc Môn, TP.HCM",
      dienGiai: "Kho công nghiệp",
      loai: "Công nghiệp",
      isActive: false,
    },
    {
      ...
      name: "Kho Quận 8",
      tenKhac: "Kho Q8",
      diaChi: "579 Đường Phạm Thế Hiển, Q.8, TP.HCM",
      dienGiai: "Kho ven sông",
      loai: "Ven sông",
      isActive: true,
    },
    {
      ...
      name: "Kho Quận 4",
      tenKhac: "Kho Q4",
      diaChi: "680 Đường Nguyễn Tất Thành, Q.4, TP.HCM",
      dienGiai: "Kho cảng biển",
      loai: "Cảng biển",
      isActive: true,
    },
    {
      ...
      name: "Kho Quận 2",
      tenKhac: "Kho Q2",
      diaChi: "791 Đường Mai Chí Thọ, TP.Thủ Đức, TP.HCM",
      dienGiai: "Kho hiện đại",
      loai: "Hiện đại",
      isActive: true,
    },
  ]);
  ...
  const [storageLocationSearchCode, setStorageLocationSearchCode] =
    useState("");
  const [storageLocationSearchName, setStorageLocationSearchName] =
    useState("");

  // Search states for transport methods
  const [transportMethodSearchCode, setTransportMethodSearchCode] =
    useState("");
  const [transportMethodSearchName, setTransportMethodSearchName] =
    useState("");

  // Search states for receipt templates
  const [receiptTemplateSearchDiemThu, setReceiptTemplateSearchDiemThu] =
    useState("");
  const [receiptTemplateSearchCode, setReceiptTemplateSearchCode] =
    useState("");
  const [receiptTemplateSearchKyHieu, setReceiptTemplateSearchKyHieu] =
    useState("");
  ...
  const [enterprisesList, setEnterprisesList] = useState([
    {
      ...
      code: "EN001",
      name: "Công ty ABC",
      description: "Công ty TNHH ABC - Logistics",
      isActive: true,
    },
    {
      id: 2,
      code: "EN002",
      name: "Công ty XYZ",
      description: "Công ty CP XYZ - Vận tải",
      isActive: true,
    },
    {
      id: 3,
      code: "EN003",
      name: "Công ty DEF",
      description: "Công ty TNHH DEF - Thương mại",
      isActive: true,
    },
  ]);
  ...
  const [transportMethodsList, setTransportMethodsList] = useState([
    {
      ...
      name: "Đường bộ",
      tenKhac: "Road",
      dienGiai: "Vận chuyển hàng hóa bằng xe tải, container trên đường bộ",
      naccs: "RD01",
      isActive: true,
    },
    {
      ...
      name: "Đường thủy",
      tenKhac: "Sea",
      dienGiai: "Vận chuyển bằng tàu biển, sà lan qua cảng biển",
      naccs: "SE02",
      isActive: true,
    },
    {
      ...
      name: "Đường sắt",
      tenKhac: "Rail",
      dienGiai: "Vận chuyển bằng tàu hỏa, container trên đường ray",
      naccs: "RL03",
      isActive: false,
    },
    {
      ...
      tenKhac: "Air",
      dienGiai: "Vận chuyển bằng máy bay cargo qua sân bay",
      naccs: "AR04",
      isActive: true,
    },
    {
      ...
      name: "Kết hợp",
      tenKhac: "Multi",
      dienGiai: "Vận chuyển đa phương thức, kết hợp nhiều loại",
      naccs: "MT05",
      isActive: true,
    },
    {
      ...
      name: "Đường ống",
      tenKhac: "Pipeline",
      dienGiai: "Vận chuyển dầu khí qua hệ thống đường ống",
      naccs: "PL06",
      isActive: true,
    },
    {
      ...
      name: "Courier",
      tenKhac: "Express",
      dienGiai: "Chuyển phát nhanh bưu phẩm, hàng nhỏ",
      naccs: "CR07",
      isActive: true,
    },
    {
      ...
      name: "Bưu điện",
      tenKhac: "Post",
      dienGiai: "Vận chuyển qua hệ thống bưu chính quốc gia",
      naccs: "PS08",
      isActive: false,
    },
    {
      ...
      name: "Xe máy",
      tenKhac: "Motorbike",
      dienGiai: "Giao hàng bằng xe máy trong nội thành",
      naccs: "MB09",
      isActive: true,
    },
    {
      ...
      name: "Thủy nội địa",
      tenKhac: "River",
      dienGiai: "Vận chuyển trên sông, kênh rạch nội địa",
      naccs: "RV10",
      isActive: true,
    },
    {
      ...
      name: "Container",
      tenKhac: "FCL",
      dienGiai: "Vận chuyển hàng hóa bằng container đầy",
      naccs: "CT11",
      isActive: true,
    },
    {
      ...
      name: "Lẻ (LCL)",
      tenKhac: "LCL",
      dienGiai: "Vận chuyển hàng rời, ghép chung container",
      naccs: "LC12",
      isActive: false,
    },
    {
      ...
      name: "Rơ-moóc",
      tenKhac: "Trailer",
      dienGiai: "Vận chuyển bằng xe đầu kéo rơ-moóc lớn",
      naccs: "TR13",
      isActive: true,
    },
    {
      ...
      name: "Xe tải nhỏ",
      tenKhac: "Pickup",
      dienGiai: "Vận chuyển hàng nhỏ bằng xe bán tải",
      naccs: "PU14",
      isActive: true,
    },
    {
      ...
      name: "Xe chuyên dụng",
      tenKhac: "Special",
      dienGiai: "Xe chuyên dụng cho hàng đặc biệt",
      naccs: "SP15",
      isActive: true,
    },
  ]);
  ...
  const [receiptTemplatesList, setReceiptTemplatesList] = useState([
    {
      ...
      diemThuPhi: "Trạm A1 - Cầu Rạch Miễu",
      ghiChu: "Biên lai thu phí cầu đường",
    ...
    },
    {
      ...
      tuSo: "0001001",
      denSo: "0002000",
      ngayHieuLuc: "2024-01-15",
      diemThuPhi: "Trạm B2 - Cầu Phú Mỹ",
      ghiChu: "Biên lai phí hạ tầng giao thông",
      trangThai: "Đang sử dụng",
      phatHanh: "Đã phát hành",
      nguoiTao: "Manager",
      isActive: true,
    },
    {
      ...
      diemThuPhi: "Trạm C3 - Cầu Cần Thơ",
      ghiChu: "Hết hiệu lực theo quyết định 123",
      trangThai: "Hết hiệu lực",
      phatHanh: "Chưa phát hành",
      nguoiTao: "Admin",
      isActive: false,
    },
    {
      ...
      tuSo: "0003001",
      denSo: "0004000",
      ngayHieuLuc: "2024-02-15",
      diemThuPhi: "Trạm D4 - Cầu Mỹ Thuận",
      ghiChu: "Biên lai thu phí vận tải",
      trangThai: "Đang sử dụng",
      phatHanh: "Đã phát hành",
      nguoiTao: "Operator",
      isActive: true,
    },
    {
      ...
      diemThuPhi: "Trạm E5 - Cầu An Thái",
      ghiChu: "Phí dịch vụ hạ tầng",
      trangThai: "Đang sử dụng",
      phatHanh: "Đã phát hành",
      nguoiTao: "Admin",
      isActive: true,
    },
    {
      ...
      diemThuPhi: "Trạm F6 - Cầu Bến Tre",
      ghiChu: "Chờ phê duyệt từ cục thuế",
    ...
    },
    {
      ...
      tuSo: "0006001",
      denSo: "0007000",
      ngayHieuLuc: "2024-04-01",
      diemThuPhi: "Trạm G7 - Cầu Vàm Cống",
      ghiChu: "Biên lai mới được cấp phép",
    ...
    },
    {
      ...
      tuSo: "0007001",
      denSo: "0008000",
      ngayHieuLuc: "2024-04-15",
      diemThuPhi: "Trạm H8 - Cầu Long Kiển",
      ghiChu: "Hết hiệu lực do hết hạn sử dụng",
      trangThai: "Hết hiệu lực",
      phatHanh: "Chưa phát hành",
      nguoiTao: "Admin",
      isActive: false,
    },
    {
      ...
      tuSo: "0008001",
      denSo: "0009000",
      ngayHieuLuc: "2024-05-01",
      diemThuPhi: "Trạm I9 - Cầu Đồng Nai",
      ghiChu: "Biên lai thu phí cao tốc",
      trangThai: "Đang sử dụng",
      phatHanh: "Đã phát hành",
      nguoiTao: "Manager",
      isActive: true,
    },
    {
      id: 10,
      mauBL: "Mẫu J10",
      kyHieuBL: "01J10O0-010",
      tuSo: "0009001",
      denSo: "0010000",
      ngayHieuLuc: "2024-05-15",
      diemThuPhi: "Trạm J10 - Cầu Sài Gòn",
      ghiChu: "Phí sử dụng cơ sở hạ tầng",
      trangThai: "Chưa sử dụng",
      phatHanh: "Đã phát hành",
      nguoiTao: "Operator",
      isActive: true,
    },
    {
      id: 11,
      mauBL: "Mẫu K11",
      kyHieuBL: "01K11O0-011",
      tuSo: "0010001",
      denSo: "0011000",
      ngayHieuLuc: "2024-06-01",
      diemThuPhi: "Trạm K11 - Cầu Thủ Thiêm",
      ghiChu: "Chờ xét duyệt từ ban giám đốc",
      trangThai: "Chờ phê duyệt",
      phatHanh: "Chưa phát hành",
      nguoiTao: "Admin",
      isActive: true,
    },
    {
      id: 12,
      mauBL: "Mẫu L12",
      kyHieuBL: "01L12O0-012",
      tuSo: "0011001",
      denSo: "0012000",
      ngayHieuLuc: "2024-06-15",
      diemThuPhi: "Trạm L12 - Cầu Phú Long",
      ghiChu: "Biên lai thu phí đặc biệt",
      trangThai: "Đang sử dụng",
      phatHanh: "Đã phát hành",
      nguoiTao: "Manager",
      isActive: true,
    },
    {
      id: 13,
      mauBL: "Mẫu M13",
      kyHieuBL: "01M13O0-013",
      tuSo: "0012001",
      denSo: "0013000",
      ngayHieuLuc: "2024-07-01",
      diemThuPhi: "Trạm M13 - Cầu Bình Lợi",
      ghiChu: "Ngừng sử dụng theo chỉ đạo mới",
      trangThai: "Hết hiệu lực",
      phatHanh: "Chưa phát hành",
      nguoiTao: "Operator",
      isActive: false,
    },
    {
      id: 14,
      mauBL: "Mẫu N14",
      kyHieuBL: "01N14O0-014",
      tuSo: "0013001",
      denSo: "0014000",
      ngayHieuLuc: "2024-07-15",
      diemThuPhi: "Trạm N14 - Cầu Bình Triệu",
      ghiChu: "Áp dụng mức phí mới 2024",
      trangThai: "Chưa sử dụng",
      phatHanh: "Đã phát hành",
      nguoiTao: "Admin",
      isActive: true,
    },
    {
      id: 15,
      mauBL: "Mẫu O15",
      kyHieuBL: "01O15O0-015",
      tuSo: "0014001",
      denSo: "0015000",
      ngayHieuLuc: "2024-08-01",
      diemThuPhi: "Trạm O15 - Cầu Kênh Tẻ",
      ghiChu: "Biên lai thí điểm giai đoạn 1",
      trangThai: "Đang sử dụng",
      phatHanh: "Đã phát hành",
      nguoiTao: "Manager",
      isActive: true,
  ...
  const [formTypesList, setFormTypesList] = useState([
    {
      ...
      maLoaiHinh: "LH001",
      tenLoaiHinh: "Xuất khẩu container đầy",
      dienGiai: "Container đầy xuất khẩu qua cảng",
      isActive: true,
    },
    {
      id: 2,
      nhomLoaiHinh: "Xuất nhập khẩu",
      maLoaiHinh: "LH002",
      tenLoaiHinh: "Nhập khẩu container đầy",
      dienGiai: "Container đầy nhập khẩu từ cảng",
      isActive: true,
    },
    {
      id: 3,
      nhomLoaiHinh: "Xuất nhập khẩu",
      maLoaiHinh: "LH003",
      tenLoaiHinh: "Container rỗng xuất",
      dienGiai: "Container rỗng xuất đi nước ngoài",
      isActive: true,
    },
    {
      id: 4,
      nhomLoaiHinh: "Nội địa",
      maLoaiHinh: "LH004",
      tenLoaiHinh: "Vận chuyển nội địa",
      dienGiai: "Vận chuyển hàng hóa trong nước",
      isActive: true,
    },
    {
      id: 5,
      nhomLoaiHinh: "Quá cảnh",
      maLoaiHinh: "LH005",
      tenLoaiHinh: "Quá cảnh container",
      dienGiai: "Container quá cảnh qua Việt Nam",
      isActive: false,
    },
    {
      id: 6,
      nhomLoaiHinh: "Đặc biệt",
      maLoaiHinh: "LH006",
      tenLoaiHinh: "Hàng nguy hiểm",
      dienGiai: "Vận chuyển hàng nguy hiểm theo quy định",
      isActive: true,
    },
    {
      id: 7,
      nhomLoaiHinh: "Đặc biệt",
      maLoaiHinh: "LH007",
      tenLoaiHinh: "Hàng siêu trường siêu trọng",
      dienGiai: "Hàng có kích thước hoặc trọng lượng vượt chuẩn",
      isActive: true,
    },
    {
      id: 8,
      nhomLoaiHinh: "Nội địa",
      maLoaiHinh: "LH008",
      tenLoaiHinh: "Liên vận quốc tế",
      dienGiai: "Vận chuyển liên vận với các nước láng giềng",
      isActive: true,
    },
    {
      id: 9,
      nhomLoaiHinh: "Xuất nhập khẩu",
      maLoaiHinh: "LH009",
      tenLoaiHinh: "Container lạnh",
      dienGiai: "Container lạnh cho hàng đông lạnh",
      isActive: true,
    },
    {
      id: 10,
      nhomLoaiHinh: "Đặc biệt",
      maLoaiHinh: "LH010",
      tenLoaiHinh: "Container tank",
      dienGiai: "Container chuyên dụng chở chất lỏng",
      isActive: true,
    },
    {
      id: 11,
      nhomLoaiHinh: "Nội địa",
      maLoaiHinh: "LH011",
      tenLoaiHinh: "Xe tải thường",
      dienGiai: "Vận chuyển bằng xe tải thông thường",
      isActive: true,
    },
    {
      id: 12,
      nhomLoaiHinh: "Quá cảnh",
      maLoaiHinh: "LH012",
      tenLoaiHinh: "Quá cảnh hàng lẻ",
      dienGiai: "Hàng lẻ quá cảnh không thay đổi phương tiện",
      isActive: false,
    },
    {
      id: 13,
      nhomLoaiHinh: "Đặc biệt",
      maLoaiHinh: "LH013",
      tenLoaiHinh: "Hàng dự án",
      dienGiai: "Hàng hóa phục vụ các dự án đầu tư",
      isActive: true,
    },
    {
      id: 14,
      nhomLoaiHinh: "Xuất nhập khẩu",
      maLoaiHinh: "LH014",
      tenLoaiHinh: "Container Open Top",
      dienGiai: "Container mở nóc cho hàng siêu cao",
      isActive: true,
    },
    {
      id: 15,
      nhomLoaiHinh: "Nội địa",
      maLoaiHinh: "LH015",
      tenLoaiHinh: "Rơ moóc chuyên dụng",
      dienGiai: "Rơ moóc chuyên chở container và hàng nặng",
      isActive: true,
    },
  ]);
  ...
  const [paymentTypesList, setPaymentTypesList] = useState([
    {
      id: 1,
      maLoaiThanhToan: "LTT001",
      tenLoaiThanhToan: "Tiền mặt tại quầy",
      dienGiai: "Thanh toán bằng tiền mặt trực tiếp tại quầy thu phí",
      isActive: true,
    },
    {
      id: 2,
      maLoaiThanhToan: "LTT002",
      tenLoaiThanhToan: "Chuyển khoản ngân hàng",
      dienGiai: "Chuyển khoản qua hệ thống ngân hàng điện tử",
      isActive: true,
    },
    {
      id: 3,
      maLoaiThanhToan: "LTT003",
      tenLoaiThanhToan: "Thẻ tín dụng/ghi nợ",
      dienGiai: "Thanh toán qua thẻ tín dụng hoặc thẻ ghi nợ",
      isActive: true,
    },
    {
      id: 4,
      maLoaiThanhToan: "LTT004",
      tenLoaiThanhToan: "Ví điện tử",
      dienGiai: "Thanh toán qua các ví điện tử như MoMo, ZaloPay",
      isActive: true,
    },
    {
      id: 5,
      maLoaiThanhToan: "LTT005",
      tenLoaiThanhToan: "QR Code",
      dienGiai: "Thanh toán bằng cách quét mã QR",
      isActive: true,
    },
    {
      id: 6,
      maLoaiThanhToan: "LTT006",
      tenLoaiThanhToan: "Séc ngân hàng",
      dienGiai: "Thanh toán bằng séc của các ngân hàng",
      isActive: false,
    },
    {
      id: 7,
      maLoaiThanhToan: "LTT007",
      tenLoaiThanhToan: "Trả góp",
      dienGiai: "Thanh toán theo hình thức trả góp",
      isActive: true,
    },
    {
      id: 8,
      maLoaiThanhToan: "LTT008",
      tenLoaiThanhToan: "Bù trừ công nợ",
      dienGiai: "Bù trừ với các khoản công nợ hiện có",
      isActive: true,
    },
    {
      id: 9,
      maLoaiThanhToan: "LTT009",
      tenLoaiThanhToan: "Ủy nhiệm chi",
      dienGiai: "Thanh toán thông qua ủy nhiệm chi ngân hàng",
      isActive: true,
    },
    {
      id: 10,
      maLoaiThanhToan: "LTT010",
      tenLoaiThanhToan: "Thanh toán online",
      dienGiai: "Thanh toán trực tuyến qua website",
      isActive: true,
    },
    {
      id: 11,
      maLoaiThanhToan: "LTT011",
      tenLoaiThanhToan: "Phiếu thu tạm ứng",
      dienGiai: "Thanh toán bằng phiếu thu tạm ứng",
      isActive: false,
    },
    {
      id: 12,
      maLoaiThanhToan: "LTT012",
      tenLoaiThanhToan: "Bảo lãnh ngân hàng",
      dienGiai: "Thanh toán thông qua bảo lãnh ngân hàng",
      isActive: true,
    },
    {
      id: 13,
      maLoaiThanhToan: "LTT013",
      tenLoaiThanhToan: "Trái phiếu",
      dienGiai: "Thanh toán bằng trái phiếu doanh nghiệp",
      isActive: false,
    },
    {
      id: 14,
      maLoaiThanhToan: "LTT014",
      tenLoaiThanhToan: "Cryptocurrency",
      dienGiai: "Thanh toán bằng tiền điện tử (thí điểm)",
      isActive: false,
    },
    {
      id: 15,
      maLoaiThanhToan: "LTT015",
      tenLoaiThanhToan: "Thanh toán quốc tế",
      dienGiai: "Thanh toán bằng ngoại tệ cho các giao dịch quốc tế",
      isActive: true,
    },
  ]);
  ...
  const [containerTypesList, setContainerTypesList] = useState([
    {
      id: 1,
      maLoaiContainer: "CNT001",
      tenLoaiContainer: "20ft Dry Container",
      dienGiai: "Container khô 20 feet tiêu chuẩn cho hàng khô",
      isActive: true,
    },
    {
      id: 2,
      maLoaiContainer: "CNT002",
      tenLoaiContainer: "40ft Dry Container",
      dienGiai: "Container khô 40 feet tiêu chuẩn cho hàng khô",
      isActive: true,
    },
    {
      id: 3,
      maLoaiContainer: "CNT003",
      tenLoaiContainer: "20ft Reefer Container",
      dienGiai: "Container lạnh 20 feet cho hàng đông lạnh",
      isActive: true,
    },
    {
      id: 4,
      maLoaiContainer: "CNT004",
      tenLoaiContainer: "40ft Reefer Container",
      dienGiai: "Container lạnh 40 feet cho hàng đông lạnh",
      isActive: true,
    },
    {
      id: 5,
      maLoaiContainer: "CNT005",
      tenLoaiContainer: "40ft High Cube",
      dienGiai: "Container cao 40 feet cho hàng có chiều cao lớn",
      isActive: true,
    },
    {
      id: 6,
      maLoaiContainer: "CNT006",
      tenLoaiContainer: "20ft Open Top",
      dienGiai: "Container mở nóc 20 feet cho hàng siêu cao",
      isActive: true,
    },
    {
      id: 7,
      maLoaiContainer: "CNT007",
      tenLoaiContainer: "40ft Open Top",
      dienGiai: "Container mở nóc 40 feet cho hàng siêu cao",
      isActive: true,
    },
    {
      id: 8,
      maLoaiContainer: "CNT008",
      tenLoaiContainer: "20ft Flat Rack",
      dienGiai: "Container sàn phẳng 20 feet cho hàng siêu trường",
      isActive: false,
    },
    {
      id: 9,
      maLoaiContainer: "CNT009",
      tenLoaiContainer: "40ft Flat Rack",
      dienGiai: "Container sàn phẳng 40 feet cho hàng siêu trường",
      isActive: true,
    },
    {
      id: 10,
      maLoaiContainer: "CNT010",
      tenLoaiContainer: "20ft Tank Container",
      dienGiai: "Container bồn 20 feet cho chất lỏng",
      isActive: true,
    },
    {
      id: 11,
      maLoaiContainer: "CNT011",
      tenLoaiContainer: "40ft Tank Container",
      dienGiai: "Container bồn 40 feet cho chất lỏng",
      isActive: true,
    },
    {
      id: 12,
      maLoaiContainer: "CNT012",
      tenLoaiContainer: "45ft High Cube",
      dienGiai: "Container cao 45 feet cho hàng có thể tích lớn",
      isActive: true,
    },
    {
      id: 13,
      maLoaiContainer: "CNT013",
      tenLoaiContainer: "20ft Bulk Container",
      dienGiai: "Container rời 20 feet cho hàng rời",
      isActive: false,
    },
    {
      id: 14,
      maLoaiContainer: "CNT014",
      tenLoaiContainer: "40ft Ventilated",
      dienGiai: "Container thông gió 40 feet cho hàng cần thoáng khí",
      isActive: true,
    },
    {
      id: 15,
      maLoaiContainer: "CNT015",
      tenLoaiContainer: "20ft Insulated",
      dienGiai: "Container cách nhiệt 20 feet cho hàng nhạy cảm nhiệt độ",
      isActive: true,
    },
  ]);
  ...
  const [unitsList, setUnitsList] = useState([
    {
      ...
      maDonViTinh: "DVT001",
      tenDonViTinh: "Tấn",
      loaiDonViTinh: "Khối lượng",
      dienGiai: "Đơn vị tính theo khối lượng tấn (1000kg)",
      isActive: true,
    },
    {
      id: 2,
      maDonViTinh: "DVT002",
      tenDonViTinh: "Kilogram (Kg)",
      loaiDonViTinh: "Khối lượng",
      dienGiai: "Đơn vị tính theo khối lượng kilogram",
      isActive: true,
    },
    {
      id: 3,
      maDonViTinh: "DVT003",
      tenDonViTinh: "Mét khối (m³)",
      loaiDonViTinh: "Thể tích",
      dienGiai: "Đơn vị tính theo thể tích mét khối",
      isActive: true,
    },
    {
      id: 4,
      ...
      tenDonViTinh: "Lít",
      loaiDonViTinh: "Thể tích",
      dienGiai: "Đơn vị tính theo thể tích lít",
      isActive: true,
    },
    {
      id: 5,
      maDonViTinh: "DVT005",
      tenDonViTinh: "Chuyến",
      loaiDonViTinh: "Số lượng",
      dienGiai: "Đơn vị tính theo số chuyến vận chuyển",
      isActive: true,
    },
    {
      id: 6,
      maDonViTinh: "DVT006",
      tenDonViTinh: "Container",
      loaiDonViTinh: "Hàng container",
      dienGiai: "Đơn vị tính theo số container",
      isActive: true,
    },
    {
      id: 7,
      ...
      tenDonViTinh: "Xe",
      loaiDonViTinh: "Số lượng",
      dienGiai: "Đơn vị tính theo số lượng xe",
      isActive: false,
    },
    {
      id: 8,
      maDonViTinh: "DVT008",
      tenDonViTinh: "Mét",
      loaiDonViTinh: "Chiều dài",
      dienGiai: "Đơn vị tính theo chiều dài mét",
      isActive: true,
    },
    {
      id: 9,
      maDonViTinh: "DVT009",
      tenDonViTinh: "Kilomét",
      loaiDonViTinh: "Chiều dài",
      dienGiai: "Đơn vị tính theo khoảng cách kilomét",
      isActive: true,
    },
    {
      id: 10,
      maDonViTinh: "DVT010",
      tenDonViTinh: "Giờ",
      loaiDonViTinh: "Thời gian",
      dienGiai: "Đơn vị tính theo thời gian giờ",
      isActive: true,
    },
    {
      id: 11,
      ...
      tenDonViTinh: "Ngày",
      loaiDonViTinh: "Thời gian",
      dienGiai: "Đơn vị tính theo thời gian ngày",
      isActive: true,
    },
    {
      id: 12,
      ...
      tenDonViTinh: "Lần",
      loaiDonViTinh: "Số lượng",
      dienGiai: "Đơn vị tính theo số lần thực hiện",
      isActive: true,
    },
    {
      id: 13,
      maDonViTinh: "DVT013",
      tenDonViTinh: "Mét vuông (m²)",
      loaiDonViTinh: "Diện tích",
      dienGiai: "Đơn vị tính theo diện tích mét vuông",
      isActive: false,
    },
    {
      id: 14,
      ...
      tenDonViTinh: "Hecta",
      loaiDonViTinh: "Diện tích",
      dienGiai: "Đơn vị tính theo diện tích hecta",
      isActive: true,
    },
    {
      id: 15,
      maDonViTinh: "DVT015",
      tenDonViTinh: "Tỷ lệ phần trăm (%)",
      loaiDonViTinh: "Tỷ lệ",
      dienGiai: "Đơn vị tính theo tỷ lệ phần trăm",
      isActive: true,
    },
  ]);
  ...
  const [showAddStorageLocationModal, setShowAddStorageLocationModal] =
    useState(false);
  const [showAddEnterpriseModal, setShowAddEnterpriseModal] = useState(false);
  const [showAddTransportMethodModal, setShowAddTransportMethodModal] =
    useState(false);
  const [showAddReceiptTemplateModal, setShowAddReceiptTemplateModal] =
    useState(false);
  ...
  const [showAddContainerTypeModal, setShowAddContainerTypeModal] =
    useState(false);
  ...
  const [usersMockShouldBeRemoved] = useState([
    {
      id: 1,
      username: "test123",
      fullName: "Đội trưởng",
  ...
  const handleViewDetail = (userId: string, userName: string) => {
    const user = users.find(
      (u) => u.username === userId && u.fullName === userName
    );
    if (user) {
  ...
  const handleDeleteUser = (
    ...
    modal.innerHTML = `
      <div class="bg-white rounded-lg w-full max-w-md shadow-xl">
        <div class="p-4 border-b flex items-center">
          ...
          <h3 class="font-semibold text-gray-800">Xác nhận xóa tài khoản</h3>
        </div>
        <div class="p-4 text-gray-700">
          Bạn có chắc chắn muốn xóa tài khoản <b>${userId}</b> - "${userName}"? Hành động này không thể hoàn tác.
        </div>
        <div class="p-4 border-t flex justify-end gap-2">
          <button id="cancelDeleteUser" class="px-4 py-2 rounded border bg-white text-gray-700 hover:bg-gray-50">Hủy</button>
          <button id="confirmDeleteUser" class="px-4 py-2 rounded bg-red-600 text-white hover:bg-red-700">Xóa</button>
        </div>
      </div>
    `;
    ...
    confirmBtn?.addEventListener("click", async () => {
      try {
        const numericId =
          internalId || selectedUser?.id || selectedUser?.userId;
        if (!numericId) {
          console.warn(
            "Không có id nội bộ, thử tìm trong danh sách theo username"
          );
        }
        if (numericId) {
          await CrmApiService.deleteSysUser(Number(numericId));
        }
        setUsers((prev: any[]) =>
          prev.filter((u: any) => u.username !== userId)
        );
  ...
  // Function để load danh sách user từ database
  const loadUsers = async () => {
    try {
      setLoadingUsers(true);
      const response = await CrmApiService.getAllSysUsers();
      const usersDataRaw = response?.data || [];
      const usersData = usersDataRaw.map((u: any) => ({
        id: u?.id ?? u?.userId ?? u?.user_id ?? null,
        userId: u?.userId ?? u?.id ?? u?.user_id ?? null,
        username: u?.username ?? "",
        fullName: u?.fullname ?? u?.fullName ?? "",
        department: u?.department ?? u?.phongBan ?? "",
        functionGroup: u?.chucVu ?? u?.position ?? "",
      ...
      setUsers(usersData);
      console.log(
        "📋 Đã load danh sách user từ database:",
        usersData.length,
        "users"
      );
    } catch (error: any) {
      console.error("❌ Lỗi khi load danh sách user:", error);
      showError(
        "Không thể tải danh sách người dùng: " + (error?.message || error)
      );
    } finally {
  ...
  // Function để mở modal quản lý quyền user
  const handleManageUserPermissions = async (user: any) => {
    try {
      setSelectedUser(user);

      // Lấy quyền của nhóm user
      const groupPermissions = await CrmApiService.getUserPermissionsByGroup(
        user.groupId || 1
      );
      setUserGroupPermissions(groupPermissions);

      // Lấy danh sách chức năng bị tắt của user
      const disabledResponse = await CrmApiService.getDisabledFeaturesByUser(
        user.id || user.userId
      );
      const disabledFeatures = disabledResponse?.data || [];
      setUserDisabledFeatures(disabledFeatures);

      setShowUserPermissionModal(true);
    } catch (error: any) {
      showError("Không thể tải thông tin quyền: " + (error?.message || error));
    }
  };

  // Function để toggle chức năng (tắt/bật)
  const handleToggleFeature = async (
    ...
    try {
      if (isCurrentlyDisabled) {
        // Bật lại chức năng (xóa record trong sys-dis-feat)
        const disabledFeature = userDisabledFeatures.find(
          (f) => f.funcId === funcId
        );
        if (disabledFeature?.id) {
          await CrmApiService.deleteSysDisFeat(disabledFeature.id);

          // Refresh dữ liệu từ database
          const disabledResponse =
            await CrmApiService.getDisabledFeaturesByUser(
              selectedUser.id || selectedUser.userId
            );
          const updatedDisabledFeatures = disabledResponse?.data || [];
          setUserDisabledFeatures(updatedDisabledFeatures);

          showSuccess(
            `Đã bật lại chức năng: ${CrmApiService.getFunctionName(funcId)}`
          );
        }
      } else {
        // Tắt chức năng (tạo record trong sys-dis-feat)
        const response = await CrmApiService.createSysDisFeat({
          userId: selectedUser.id || selectedUser.userId,
          funcId: funcId,
        });

        const newDisabledFeature = response?.data || response;
        if (newDisabledFeature && newDisabledFeature.id) {
          // Refresh dữ liệu từ database
          const disabledResponse =
            await CrmApiService.getDisabledFeaturesByUser(
              selectedUser.id || selectedUser.userId
          ...
          showSuccess(
            `Đã tắt chức năng: ${CrmApiService.getFunctionName(funcId)}`
          );
        }
      }
    } catch (error: any) {
      showError(
        `Không thể thay đổi trạng thái chức năng: ${error?.message || error}`
      );
    }
  };
  ...
  const handleDeleteGroup = async (groupId: number, groupName: string) => {
    // Tạo modal confirm đẹp thay vì window.confirm
    ...
    confirmModal.innerHTML = `
      <div class="bg-white rounded-lg p-6 w-96 max-w-full">
        ...
        <div class="text-center">
          <h3 class="text-lg font-medium text-gray-900 mb-2">Xác nhận xóa nhóm</h3>
          <p class="text-sm text-gray-500 mb-6">
            Bạn có chắc chắn muốn xóa nhóm <span class="font-semibold text-gray-900">"${groupName}"</span>?<br>
            <span class="text-red-600">Hành động này không thể hoàn tác.</span>
          </p>
          <div class="flex gap-3 justify-center">
            <button id="cancelDelete" class="px-4 py-2 text-gray-600 border border-gray-300 rounded hover:bg-gray-50 transition-colors">
              Hủy
            </button>
    ...
    confirmBtn?.addEventListener("click", async () => {
      cleanup();
      try {
        const res = await CrmApiService.deleteSysGroupUser(groupId);
        if (res !== null && res !== undefined) {
          showSuccess(`Đã xóa nhóm: ${groupName}`);
          // Reload danh sách từ backend để đảm bảo dữ liệu mới nhất
          setTimeout(() => loadGroups(), 500);
        } else {
          showError("Xóa nhóm thất bại");
        }
      } catch (err: any) {
        showError(err?.message || "Xóa nhóm thất bại");
      }
    });
  ...
  const filteredUsersList = users.filter((user) => {
    const departmentMatch =
      userSearchDepartment === "" ||
      user.department
        .toLowerCase()
        .includes(userSearchDepartment.toLowerCase());
    const officeMatch =
      userSearchOffice === "" ||
  ...
  const filteredBusinessList = businessList.filter((business) => {
    const statusMatch =
      businessSearchStatus === "" || business.status === businessSearchStatus;
    const codeMatch =
      businessSearchCode === "" ||
  ...
  const handleDeleteCustoms = (customsId: number, customsName: string) => {
    const confirmed = window.confirm(
      `Bạn có chắc chắn muốn xóa "${customsName}"?`
    );
    if (confirmed) {
      setCustomsList((prev) => {
  ...
  const createHandlers = (
    ...
    const handleSubmit = (e: React.FormEvent) => {
      ...
      alert(
        `Đã thêm ${title
          .toLowerCase()
          .replace("danh mục ", "")} mới thành công!`
      );
    ...
    const handleViewDetail = (itemName: string, list: any[]) => {
      const item = list.find(
        (i) =>
          i.name === itemName ||
          i.tenLoaiHinh === itemName ||
          i.tenLoaiThanhToan === itemName ||
          i.tenLoaiContainer === itemName ||
          i.tenDonViTinh === itemName
      );
      if (item) {
  ...
  const filteredStorageLocationsList = storageLocationsList.filter((item) => {
    const codeMatch = item.code
      .toLowerCase()
      .includes(storageLocationSearchCode.toLowerCase());
    const nameMatch = item.name
      .toLowerCase()
      .includes(storageLocationSearchName.toLowerCase());
    return codeMatch && nameMatch;
  });
  ...
  const filteredTransportMethodsList = transportMethodsList.filter((item) => {
    const codeMatch = item.code
      .toLowerCase()
      .includes(transportMethodSearchCode.toLowerCase());
    const nameMatch = item.name
      .toLowerCase()
      .includes(transportMethodSearchName.toLowerCase());
    return codeMatch && nameMatch;
  });
  ...
  const filteredReceiptTemplatesList = receiptTemplatesList.filter((item) => {
    const diemThuMatch =
      receiptTemplateSearchDiemThu === "" ||
      item.diemThuPhi
        .toLowerCase()
        .includes(receiptTemplateSearchDiemThu.toLowerCase());
    const codeMatch =
      receiptTemplateSearchCode === "" ||
      item.kyHieuBL
        .toLowerCase()
        .includes(receiptTemplateSearchCode.toLowerCase());
    const kyHieuMatch =
      receiptTemplateSearchKyHieu === "" ||
      item.kyHieuBL
        .toLowerCase()
        .includes(receiptTemplateSearchKyHieu.toLowerCase());
  ...
  const receiptTemplateHandlers = {
    ...
    handleViewDetail: (itemName: string) => {
      const item = receiptTemplatesList.find(
        (i) => i.kyHieuBL === itemName || i.mauBL === itemName
      );
      if (item) {
  ...
  const filteredTariffTypesList = tariffTypesList.filter((item) => {
    const nameMatch =
      tariffTypeSearchName === "" ||
      (item.ten || item.name || "")
        .toLowerCase()
        .includes(tariffTypeSearchName.toLowerCase());
    const codeMatch =
      tariffTypeSearchCode === "" ||
      (item.ma || item.code || "")
        .toLowerCase()
        .includes(tariffTypeSearchCode.toLowerCase());
  ...
  const filteredTariffsList = tariffsList.filter((item) => {
    const bieuCuocMatch =
      tariffSearchBieuCuoc === "" || item.bieuCuoc === tariffSearchBieuCuoc;
    const bieuCuocThueMatch =
      tariffSearchBieuCuocThue === "" ||
      item.bieuCuocThue === tariffSearchBieuCuocThue;
    const maBieuCuocMatch =
      tariffSearchMaBieuCuoc === "" ||
      item.maBieuCuoc
        .toLowerCase()
        .includes(tariffSearchMaBieuCuoc.toLowerCase());
    const tenBieuCuocMatch =
      tariffSearchTenBieuCuoc === "" ||
      item.tenBieuCuoc
        .toLowerCase()
        .includes(tariffSearchTenBieuCuoc.toLowerCase());
    return (
      bieuCuocMatch && bieuCuocThueMatch && maBieuCuocMatch && tenBieuCuocMatch
    );
  });
  ...
  const tariffHandlers = {
    ...
    handleViewDetail: (itemName: string) => {
      const item = tariffsList.find(
        (i) => i.tenBieuCuoc === itemName || i.maBieuCuoc === itemName
      );
      if (item) {
  ...
  const enterpriseHandlers = createHandlers(
    setEnterprisesList,
    setShowAddEnterpriseModal,
  ...
  const tariffTypeHandlers = {
    ...createHandlers(
      setTariffTypesList,
      setShowAddTariffTypeModal,
      setTariffTypeFormData,
      tariffTypeFormData,
      "Danh mục loại biểu cước"
    ),
  ...
  const filteredFormTypesList = formTypesList.filter((item) => {
    const nhomMatch =
      formTypeSearchNhom === "" || item.nhomLoaiHinh === formTypeSearchNhom;
    const maMatch =
      formTypeSearchMa === "" ||
      item.maLoaiHinh.toLowerCase().includes(formTypeSearchMa.toLowerCase());
    const tenMatch =
      formTypeSearchTen === "" ||
      item.tenLoaiHinh.toLowerCase().includes(formTypeSearchTen.toLowerCase());
  ...
  const formTypeHandlers = {
    ...
    handleViewDetail: (itemName: string) => {
      const item = formTypesList.find(
        (i) => i.tenLoaiHinh === itemName || i.maLoaiHinh === itemName
      );
      if (item) {
  ...
  const filteredPaymentTypesList = paymentTypesList.filter((item) => {
    const maMatch =
      ...
      item.maLoaiThanhToan
        .toLowerCase()
        .includes(paymentTypeSearchMa.toLowerCase());
    const tenMatch =
      paymentTypeSearchTen === "" ||
      item.tenLoaiThanhToan
        .toLowerCase()
        .includes(paymentTypeSearchTen.toLowerCase());
  ...
  const paymentTypeHandlers = {
    ...
    handleViewDetail: (itemName: string) => {
      const item = paymentTypesList.find(
        (i) => i.tenLoaiThanhToan === itemName || i.maLoaiThanhToan === itemName
      );
      if (item) {
  ...
  const filteredContainerTypesList = containerTypesList.filter((item) => {
    const maMatch =
      containerTypeSearchMa === "" ||
      item.maLoaiContainer
        .toLowerCase()
        .includes(containerTypeSearchMa.toLowerCase());
    const tenMatch =
      containerTypeSearchTen === "" ||
      item.tenLoaiContainer
        .toLowerCase()
        .includes(containerTypeSearchTen.toLowerCase());
    return maMatch && tenMatch;
  });
  ...
  const containerTypeHandlers = {
    ...
    handleViewDetail: (itemName: string) => {
      const item = containerTypesList.find(
        (i) => i.tenLoaiContainer === itemName || i.maLoaiContainer === itemName
      );
      if (item) {
  ...
  const filteredUnitsList = unitsList.filter((item) => {
    const donViTinhMatch =
      unitSearchDonViTinh === "" || item.loaiDonViTinh === unitSearchDonViTinh;
    const maMatch =
      unitSearchMa === "" ||
      item.maDonViTinh.toLowerCase().includes(unitSearchMa.toLowerCase());
    const tenMatch =
      unitSearchTen === "" ||
      item.tenDonViTinh.toLowerCase().includes(unitSearchTen.toLowerCase());
  ...
  const unitHandlers = {
    ...
    handleViewDetail: (itemName: string) => {
      const item = unitsList.find(
        (i) => i.tenDonViTinh === itemName || i.maDonViTinh === itemName
      );
      if (item) {
  ...
  const currentItems = filteredCustomsList.slice(
    indexOfFirstItem,
    indexOfLastItem
  );
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-3">
                <div className="text-sm text-gray-700">
                  Có {list.length}/200 bản ghi - Trang: {currentPage}/
                  {totalPages}
                </div>
                <input
                  type="text"
                  ...
                  <tr key={item.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-3 py-3 text-xs">
                      <div className="flex gap-2">
                        <button
                          onClick={() =>
                            handleViewDetail(item.ten || item.name || "")
                          }
                        ...
                        <button
                          onClick={() =>
                            handleDelete(item.id, item.ten || item.name || "")
                          }
                    ...
                    <td className="px-3 py-3 text-xs text-gray-900">
                      {item.dienGiai || item.description || ""}
                    </td>
                    <td className="px-3 py-3 text-xs">
                      <i
                        className={`fas ${
                          item.trangThai === "1" || item.isActive
            ...
            <div className="bg-gray-50 px-4 py-3 border-t">
              <div className="flex items-center justify-between">
                <div className="text-sm text-gray-700">
                  ...
                  {Math.min(indexOfLastItem, list.length)} của {list.length} bản
                  ghi
                </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      handleFormChange("dienGiai", e.target.value)
                    }
                ...
                <div className="flex items-center gap-4">
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      handleFormChange("trangThai", e.target.value)
                    }
                    className="flex-1 border border-gray-300 rounded px-3 py-2 focus:outline-none focus:border-blue-500"
                  >
  ...
  const getPageContent = () => {
    switch (location.pathname) {
                  ...
                  <div className="flex flex-wrap items-center gap-3 justify-end">
                    ...
                    >
                      ...
                      {[
                        ...new Set(
                          users.map((u) =>
                            (u?.department ?? "").includes(" - ")
                              ? (u?.department as string).split(" - ")[1]
                              : u?.department ?? ""
                          )
                        ),
                      ].map((dept) => (
                    ...
                    >
                      ...
                      {[
                        ...new Set(
                          users.map((u) =>
                            (u?.department ?? "").includes(" - ")
                              ? (u?.department as string).split(" - ")[0]
                              : u?.department ?? ""
                          )
                        ),
                      ].map((office) => (
                    ...
                    >
                      ...
                      {[...new Set(users.map((u) => u.position))].map(
                        (position) => (
                ...
                <div className="bg-white rounded-lg shadow-sm overflow-hidden">
                  <div className="overflow-x-auto">
                    <table className="w-full">
                      ...
                      <tbody className="bg-white divide-y divide-gray-200">
                        {(() => {
                          ...
                          const usersIndexOfLastItem =
                            currentPage * itemsPerPage;
                          const usersIndexOfFirstItem =
                            usersIndexOfLastItem - itemsPerPage;
                          const currentUsers = filteredUsersList.slice(
                            usersIndexOfFirstItem,
                            usersIndexOfLastItem
                          );

                          return currentUsers.map((user, index) => (
                            <tr key={user.id} className="hover:bg-gray-50">
                              <td className="px-4 py-3 text-sm text-gray-900">
                                {usersIndexOfFirstItem + index + 1}
                              </td>
                    ...
                    <div className="px-4 py-3 bg-gray-50 border-t flex items-center justify-between">
                      <div className="text-sm text-gray-700">
                        Có {filteredUsersList.length}/{users.length} bản ghi -
                        Trang: {currentPage}/
                        {(() => {
                          const usersTotalPages = Math.ceil(
                            filteredUsersList.length / itemsPerPage
                          ...
                          <tbody className="bg-white divide-y divide-gray-200">
                            {loadingUsers ? (
                              ...
                              <tr>
                                ...
                                >
                                  <i className="fas fa-users text-gray-300 text-2xl mb-2 block"></i>
                              ...
                              users.map((user, index) => (
                                ...
                                >
                                  ...
                                  <td className="px-4 py-3 text-sm text-gray-900">
                                    {user.groupName || `Nhóm ${user.groupId}`}
                                  </td>
                                  <td className="px-4 py-3 text-sm text-gray-900">
                                    {user.note || "Chưa có"}
                                  </td>
            ...
            {showAddGroupModal && (
              <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
                <div className="bg-white rounded-lg p-4 w-1/2 max-h-[90vh] overflow-y-auto">
                  ...
                  {/* Modal Form - chỉ giữ Tên nhóm theo backend */}
                  <form
                    onSubmit={async (e) => {
                      e.preventDefault();
                      if (
                        !groupFormData.groupName ||
                        groupFormData.groupName.trim() === ""
                      ) {
                      ...
                      try {
                        if (editingGroupId) {
                          // Gọi API update nhóm người dùng
                          const res = await CrmApiService.updateSysGroupUser({
                            id: editingGroupId,
                            groupName: groupFormData.groupName.trim(),
                          });
                          const updated = res?.data || res;
                          if (updated && (updated.id || updated.groupName)) {
                            showSuccess("Cập nhật nhóm người dùng thành công");
                            // Reload danh sách từ backend để đảm bảo dữ liệu mới nhất
                            setTimeout(() => loadGroups(), 500);
                          } else {
                            showError("Cập nhật nhóm thất bại");
                          }
                        } else {
                          const res = await CrmApiService.createSysGroupUser({
                            groupName: groupFormData.groupName.trim(),
                          });
                          const created = res?.data || res;
                          if (created && (created.groupName || created.id)) {
                            setGroups((prev: any[]) => [
                              {
                          ...
                          showSuccess("Tạo nhóm người dùng thành công");
                          // Reload danh sách từ backend để đảm bảo dữ liệu mới nhất
                          setTimeout(() => loadGroups(), 500);
                        }
                        handleCloseGroupModal();
                      } catch (err: any) {
                        showError(err?.message || "Tạo nhóm thất bại");
                      }
                    }}
                    className="space-y-4"
                  >
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <textarea
                        ...
                        onChange={(e) =>
                          handleGroupFormChange("groupName", e.target.value)
                        }
                  ...
                  <form onSubmit={handleSubmitForm} className="space-y-2">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      >
                        ...
                        <option value="02CC">
                          02CC - Chi cục HQCK cảng KV1
                        </option>
                        <option value="03CC">
                          03CC - Chi cục HQCK cảng KV2
                        </option>
                        <option value="04CC">
                          04CC - Chi cục HQCK cảng KV3
                        </option>
                        <option value="05CC">
                          05CC - Chi cục HQCK cảng KV4
                        </option>
                        <option value="06CC">
                          06CC - Chi cục HQCK cảng KV5
                        </option>
                      </select>
                    </div>
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          handleFormChange("office", e.target.value)
                        }
                        className="flex-1 border border-gray-300 rounded px-3 py-2 focus:outline-none focus:border-blue-500"
                      >
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          handleFormChange("teamManager", e.target.value)
                        }
                        className="flex-1 border border-gray-300 rounded px-3 py-2 focus:outline-none focus:border-blue-500"
                      >
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          handleFormChange("tollStation", e.target.value)
                        }
                        className="flex-1 border border-gray-300 rounded px-3 py-2 focus:outline-none focus:border-blue-500"
                      >
      ...
      case "/system/business":
        const businessTotalPages = Math.ceil(
          filteredBusinessList.length / itemsPerPage
        );
        ...
        const currentBusiness = filteredBusinessList.slice(
          businessIndexOfFirstItem,
          businessIndexOfLastItem
        );
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <div className="px-4 py-3 border-b">
                <div className="flex items-center justify-between">
                  <div className="text-sm text-gray-700">
                    Có {filteredBusinessList.length}/{businessList.length} bản
                    ghi - Trang: {currentPage}/{businessTotalPages}
                  </div>
                  <div className="flex items-center gap-3">
                    <select
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <div className="overflow-x-auto">
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {currentBusiness.map((business, index) => (
                      <tr key={business.id} className="hover:bg-gray-50">
                        <td className="px-3 py-3 text-xs text-gray-900">
                          {businessIndexOfFirstItem + index + 1}
                        </td>
                        <td className="px-3 py-3 text-xs">
                          <div className="flex gap-2">
                            <button
                            ...
                            <button
                              onClick={() => {
                                const confirmed = window.confirm(
                                  `Bạn có chắc chắn muốn xóa "${business.name}"?`
                                );
                                if (confirmed) {
                        ...
                        <td className="px-3 py-3 text-xs">
                          <button
                            onClick={() =>
                              alert(`Sửa thông tin: ${business.name}`)
                            }
                            className="text-blue-500 hover:text-blue-700"
                            title="Sửa thông tin"
                          >
                ...
                <div className="px-4 py-3 bg-gray-50 border-t flex items-center justify-between">
                  <div className="text-sm text-gray-700">
                    Hiển thị {businessIndexOfFirstItem + 1}-
                    {Math.min(
                      businessIndexOfLastItem,
                      filteredBusinessList.length
                    )}{" "}
                    của {filteredBusinessList.length} bản ghi
                  </div>
                  <div className="flex items-center gap-2">
                    <button
                      onClick={handlePrevPage}
                    ...
                    <div className="flex gap-1">
                      {Array.from(
                        { length: Math.min(businessTotalPages, 5) },
                        (_, i) => {
                          const page = i + 1;
                          return (
                            <button
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <div className="px-4 py-3 border-b">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-3">
                    <div className="text-sm text-gray-700">
                      Có {filteredCustomsList.length}/{customsList.length} bản
                      ghi - Trang: {currentPage}/{totalPages}
                    </div>
                    <input
                      type="text"
              ...
              <div className="overflow-x-auto">
                      ...
                      <tr key={customs.id} className="hover:bg-gray-50">
                        ...
                        <td className="px-3 py-3 text-xs">
                          <div className="flex gap-2">
                            <button
                              onClick={() =>
                                handleViewCustomsDetail(customs.name)
                              }
                              className="text-blue-500 hover:text-blue-700"
                              title="Xem chi tiết"
                            >
                            ...
                            <button
                              onClick={() =>
                                handleDeleteCustoms(customs.id, customs.name)
                              }
                              className="text-red-500 hover:text-red-700"
                              title="Xóa"
                            >
                ...
                <div className="bg-gray-50 px-4 py-3 border-t">
                  <div className="flex items-center justify-between">
                    <div className="text-sm text-gray-700">
                      Hiển thị {indexOfFirstItem + 1}-
                      {Math.min(indexOfLastItem, customsList.length)} của{" "}
                      {customsList.length} bản ghi
                    </div>
                    <div className="flex space-x-1">
                      {/* Previous button */}
                      <button
            ...
            {showAddCustomsModal && (
              <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
                <div className="bg-white rounded-lg p-6 w-1/2 max-h-[90vh] overflow-y-auto">
                  <h2 className="text-lg font-bold text-gray-800 mb-4">
                    Cập nhật thông tin hải quan
                  </h2>

                  <form
                    onSubmit={handleSubmitCustomsForm}
                    className="space-y-4"
                  >
                    {/* Mã hải quan */}
                    <div className="flex items-center gap-4">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          handleCustomsFormChange("code", e.target.value)
                        }
                        className="flex-1 border border-gray-300 rounded px-3 py-2 focus:outline-none focus:border-blue-500"
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          handleCustomsFormChange("name", e.target.value)
                        }
                        className="flex-1 border border-gray-300 rounded px-3 py-2 focus:outline-none focus:border-blue-500"
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          handleCustomsFormChange("level", e.target.value)
                        }
                        className="flex-1 border border-gray-300 rounded px-3 py-2 focus:outline-none focus:border-blue-500"
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          handleCustomsFormChange("address", e.target.value)
                        }
                        className="flex-1 border border-gray-300 rounded px-3 py-2 focus:outline-none focus:border-blue-500"
                        placeholder="Nhập địa chỉ"
                      />
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          handleCustomsFormChange("phone", e.target.value)
                        }
                        className="flex-1 border border-gray-300 rounded px-3 py-2 focus:outline-none focus:border-blue-500"
                        placeholder="Nhập số điện thoại"
                      />
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          handleCustomsFormChange("fax", e.target.value)
                        }
                        className="flex-1 border border-gray-300 rounded px-3 py-2 focus:outline-none focus:border-blue-500"
                        placeholder="Nhập số fax"
                      />
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <textarea
                        ...
                        onChange={(e) =>
                          handleCustomsFormChange("note", e.target.value)
                        }
                        className="flex-1 border border-gray-300 rounded px-3 py-2 focus:outline-none focus:border-blue-500 h-24 resize-none"
                        placeholder="Nhập ghi chú"
                      />
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          handleCustomsFormChange("status", e.target.value)
                        }
                        className="flex-1 border border-gray-300 rounded px-3 py-2 focus:outline-none focus:border-blue-500"
                      >
      ...
      case "/system/banks":
        const banksTotalPages = Math.ceil(
          filteredBanksList.length / itemsPerPage
        );
        const banksIndexOfLastItem = currentPage * itemsPerPage;
        const banksIndexOfFirstItem = banksIndexOfLastItem - itemsPerPage;
        const currentBanks = filteredBanksList.slice(
          banksIndexOfFirstItem,
          banksIndexOfLastItem
        );
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <div className="px-4 py-3 border-b">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-3">
                    <div className="text-sm text-gray-700">
                      Có {filteredBanksList.length}/{banksList.length} bản ghi -
                      Trang: {currentPage}/{banksTotalPages}
                    </div>
                    <input
                      type="text"
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {currentBanks.map((bank, index) => (
                      <tr key={bank.id} className="hover:bg-gray-50">
                        <td className="px-3 py-3 text-xs text-gray-900">
                          {banksIndexOfFirstItem + index + 1}
                        </td>
                        <td className="px-3 py-3 text-xs">
                          <div className="flex gap-2">
                            <button
                              onClick={() =>
                                bankHandlers.handleViewDetail(bank.name)
                              }
                              className="text-blue-500 hover:text-blue-700"
                              title="Xem chi tiết"
                            >
                            ...
                            <button
                              onClick={() =>
                                bankHandlers.handleDelete(bank.id, bank.name)
                              }
                              className="text-red-500 hover:text-red-700"
                              title="Xóa"
                            >
              ...
              <div className="px-4 py-3 bg-gray-50 border-t flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <div className="flex gap-1">
                    {Array.from(
                      { length: Math.min(banksTotalPages, 5) },
                      (_, i) => {
                        const page = i + 1;
                        return (
                          <button
            ...
            {showAddBankModal && (
              <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
                <div className="bg-white rounded-lg p-6 w-1/2 max-h-[90vh] overflow-y-auto">
                  <h2 className="text-lg font-bold text-gray-800 mb-4">
                    Cập nhật thông tin ngân hàng TM
                  </h2>

                  <form
                    onSubmit={bankHandlers.handleSubmit}
                    className="space-y-4"
                  >
                    <div className="flex items-center gap-4">
                      <label className="text-sm font-medium text-gray-700 w-1/4">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          bankHandlers.handleFormChange("code", e.target.value)
                        }
                        className="flex-1 border border-gray-300 rounded px-3 py-2 focus:outline-none focus:border-blue-500"
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          bankHandlers.handleFormChange("name", e.target.value)
                        }
                        className="flex-1 border border-gray-300 rounded px-3 py-2 focus:outline-none focus:border-blue-500"
      ...
      case "/system/warehouses":
        const warehousesTotalPages = Math.ceil(
          warehousesList.length / itemsPerPage
        );
        const warehousesIndexOfLastItem = currentPage * itemsPerPage;
        const warehousesIndexOfFirstItem =
          warehousesIndexOfLastItem - itemsPerPage;
        const currentWarehouses = warehousesList.slice(
          warehousesIndexOfFirstItem,
          warehousesIndexOfLastItem
        );
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <div className="px-4 py-3 border-b">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-3">
                    <div className="text-sm text-gray-700">
                      Có {warehousesList.length}/200 bản ghi - Trang:{" "}
                      {currentPage}/{warehousesTotalPages}
                    </div>
                    <input
                      type="text"
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <div className="overflow-x-auto">
                <table className="w-full">
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {currentWarehouses.map((item, index) => (
                      <tr key={item.id} className="hover:bg-gray-50">
                        <td className="px-3 py-3 text-xs text-gray-900">
                          {warehousesIndexOfFirstItem + index + 1}
                        </td>
                        <td className="px-3 py-3 text-xs">
                          <div className="flex gap-2">
                            <button
                              onClick={() =>
                                warehouseHandlers.handleViewDetail(item.name)
                              }
                              className="text-blue-500 hover:text-blue-700"
                              title="Xem chi tiết"
                            >
                            ...
                            <button
                              onClick={() =>
                                warehouseHandlers.handleDelete(
                                  item.id,
                                  item.name
                                )
                              }
                ...
                <div className="bg-gray-50 px-4 py-3 border-t">
                  <div className="flex items-center justify-between">
                    <div className="text-sm text-gray-700">
                      Hiển thị {warehousesIndexOfFirstItem + 1}-
                      {Math.min(
                        warehousesIndexOfLastItem,
                        warehousesList.length
                      )}{" "}
                      của {warehousesList.length} bản ghi
                    </div>
                    <div className="flex space-x-1">
                      <button
                        onClick={handlePrevPage}
            ...
            {showAddWarehouseModal && (
              <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
                <div className="bg-white rounded-lg p-6 w-1/2 max-h-[90vh] overflow-y-auto">
                  <h2 className="text-lg font-bold text-gray-800 mb-4">
                    Cập nhật thông tin kho/bãi/cảng
                  </h2>

                  <form
                    onSubmit={warehouseHandlers.handleSubmit}
                    className="space-y-4"
                  >
                    <div className="flex items-center gap-4">
                      <label className="text-sm font-medium text-gray-700 w-1/4">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          warehouseHandlers.handleFormChange(
                            "code",
                            e.target.value
                          )
                        }
                    ...
                    <div className="flex justify-end space-x-3 pt-6 border-t">
                      <button
                        type="button"
                        onClick={warehouseHandlers.handleClose}
                        className="px-4 py-2 text-gray-600 border border-gray-300 rounded hover:bg-gray-50"
                      >
                        Đóng
                      </button>
      ...
      case "/system/toll-stations":
        const tollStationsTotalPages = Math.ceil(
          tollStationsList.length / itemsPerPage
        );
        const tollStationsIndexOfLastItem = currentPage * itemsPerPage;
        const tollStationsIndexOfFirstItem =
          tollStationsIndexOfLastItem - itemsPerPage;
        const currentTollStations = tollStationsList.slice(
          tollStationsIndexOfFirstItem,
          tollStationsIndexOfLastItem
        );
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <div className="px-4 py-3 border-b">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-3">
                    <div className="text-sm text-gray-700">
                      Có {tollStationsList.length}/200 bản ghi - Trang:{" "}
                      {currentPage}/{tollStationsTotalPages}
                    </div>
                    <input
                      type="text"
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <div className="overflow-x-auto">
                <table className="w-full">
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {currentTollStations.map((item, index) => (
                      <tr key={item.id} className="hover:bg-gray-50">
                        <td className="px-3 py-3 text-xs text-gray-900">
                          {tollStationsIndexOfFirstItem + index + 1}
                        </td>
                        <td className="px-3 py-3 text-xs">
                          <div className="flex gap-2">
                            <button
                              onClick={() =>
                                tollStationHandlers.handleViewDetail(item.name)
                              }
                              className="text-blue-500 hover:text-blue-700"
                              title="Xem chi tiết"
                            >
                            ...
                            <button
                              onClick={() =>
                                tollStationHandlers.handleDelete(
                                  item.id,
                                  item.name
                                )
                              }
                ...
                <div className="bg-gray-50 px-4 py-3 border-t">
                  <div className="flex items-center justify-between">
                    <div className="text-sm text-gray-700">
                      Hiển thị {tollStationsIndexOfFirstItem + 1}-
                      {Math.min(
                        tollStationsIndexOfLastItem,
                        tollStationsList.length
                      )}{" "}
                      của {tollStationsList.length} bản ghi
                    </div>
                    <div className="flex space-x-1">
                      <button
                        onClick={handlePrevPage}
            ...
            {showAddTollStationModal && (
              <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
                <div className="bg-white rounded-lg p-6 w-1/2 max-h-[90vh] overflow-y-auto">
                  <h2 className="text-lg font-bold text-gray-800 mb-4">
                    Cập nhật thông tin trạm thu phí
                  </h2>

                  <form
                    onSubmit={tollStationHandlers.handleSubmit}
                    className="space-y-4"
                  >
                    <div className="flex items-center gap-4">
                      <label className="text-sm font-medium text-gray-700 w-1/4">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          tollStationHandlers.handleFormChange(
                            "code",
                            e.target.value
                          )
                        }
                    ...
                    <div className="flex justify-end space-x-3 pt-6 border-t">
                      <button
                        type="button"
                        onClick={tollStationHandlers.handleClose}
                        className="px-4 py-2 text-gray-600 border border-gray-300 rounded hover:bg-gray-50"
                      >
                        Đóng
                      </button>
      ...
      case "/system/storage-locations":
        const storageLocationsTotalPages = Math.ceil(
          filteredStorageLocationsList.length / itemsPerPage
        );
        const storageLocationsIndexOfLastItem = currentPage * itemsPerPage;
        const storageLocationsIndexOfFirstItem =
          storageLocationsIndexOfLastItem - itemsPerPage;
        const currentStorageLocations = filteredStorageLocationsList.slice(
          storageLocationsIndexOfFirstItem,
          storageLocationsIndexOfLastItem
        );
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <div className="px-4 py-3 border-b">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-3">
                    <div className="text-sm text-gray-700">
                      Có {filteredStorageLocationsList.length}/
                      {storageLocationsList.length} bản ghi - Trang:{" "}
                      {currentPage}/{storageLocationsTotalPages}
                    </div>
                    <input
                      type="text"
                      ...
                      onChange={(e) =>
                        handleStorageLocationCodeSearch(e.target.value)
                      }
                      className="border border-gray-300 rounded px-3 py-2 text-sm w-40"
                    />
                    <input
                      ...
                      onChange={(e) =>
                        handleStorageLocationNameSearch(e.target.value)
                      }
                      className="border border-gray-300 rounded px-3 py-2 text-sm w-48"
                    />
                    <button
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <div className="overflow-x-auto">
                <table className="w-full">
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {currentStorageLocations.map((item, index) => (
                      <tr key={item.id} className="hover:bg-gray-50">
                        <td className="px-3 py-3 text-xs text-gray-900">
                          {storageLocationsIndexOfFirstItem + index + 1}
                        </td>
                        <td className="px-3 py-3 text-xs">
                          <div className="flex gap-2">
                            <button
                              onClick={() =>
                                storageLocationHandlers.handleViewDetail(
                                  item.name
                                )
                              }
                              className="text-blue-500 hover:text-blue-700"
                            ...
                            <button
                              onClick={() =>
                                storageLocationHandlers.handleDelete(
                                  item.id,
                                  item.name
                                )
                              }
                ...
                <div className="bg-gray-50 px-4 py-3 border-t">
                  <div className="flex items-center justify-between">
                    <div className="text-sm text-gray-700">
                      Hiển thị {storageLocationsIndexOfFirstItem + 1}-
                      {Math.min(
                        storageLocationsIndexOfLastItem,
                        filteredStorageLocationsList.length
                      )}{" "}
                      của {filteredStorageLocationsList.length} bản ghi
                    </div>
                    <div className="flex space-x-1">
                      <button
                        onClick={handlePrevPage}
                      ...
                      {[...Array(storageLocationsTotalPages)].map(
                        (_, index) => {
                          const pageNumber = index + 1;
                          return (
                            <button
            ...
            {showAddStorageLocationModal && (
              <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
                <div className="bg-white rounded-lg p-6 w-1/2 max-h-[90vh] overflow-y-auto">
                  <h2 className="text-lg font-bold text-gray-800 mb-4">
                    Cập nhật thông tin địa điểm lưu kho
                  </h2>

                  <form
                    onSubmit={storageLocationHandlers.handleSubmit}
                    className="space-y-4"
                  >
                    <div className="flex items-center gap-4">
                      <label className="text-sm font-medium text-gray-700 w-1/4">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          storageLocationHandlers.handleFormChange(
                            "code",
                            e.target.value
                          )
                        }
                    ...
                    <div className="flex justify-end space-x-3 pt-6 border-t">
                      <button
                        type="button"
                        onClick={storageLocationHandlers.handleClose}
                        className="px-4 py-2 text-gray-600 border border-gray-300 rounded hover:bg-gray-50"
                      >
                        Đóng
                      </button>
      ...
      case "/system/enterprises":
        return generateCatalogPage({
          ...
          showModal: showAddEnterpriseModal,
          setShowModal: setShowAddEnterpriseModal,
          formData: enterpriseFormData,
          ...enterpriseHandlers,
          title: "Danh mục doanh nghiệp",
          searchPlaceholder: "Tên doanh nghiệp",
        });
      case "/system/transport-methods":
        const transportMethodsTotalPages = Math.ceil(
          filteredTransportMethodsList.length / itemsPerPage
        );
        const transportMethodsIndexOfLastItem = currentPage * itemsPerPage;
        const transportMethodsIndexOfFirstItem =
          transportMethodsIndexOfLastItem - itemsPerPage;
        const currentTransportMethods = filteredTransportMethodsList.slice(
          transportMethodsIndexOfFirstItem,
          transportMethodsIndexOfLastItem
        );
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <div className="px-4 py-3 border-b">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-3">
                    <div className="text-sm text-gray-700">
                      Có {filteredTransportMethodsList.length}/
                      {transportMethodsList.length} bản ghi - Trang:{" "}
                      {currentPage}/{transportMethodsTotalPages}
                    </div>
                    <input
                      type="text"
                      ...
                      onChange={(e) =>
                        handleTransportMethodCodeSearch(e.target.value)
                      }
                      className="border border-gray-300 rounded px-3 py-2 text-sm w-40"
                    />
                    <input
                      ...
                      onChange={(e) =>
                        handleTransportMethodNameSearch(e.target.value)
                      }
                      className="border border-gray-300 rounded px-3 py-2 text-sm w-48"
                    />
                    <button
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <div className="overflow-x-auto">
                <table className="w-full">
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {currentTransportMethods.map((item, index) => (
                      <tr key={item.id} className="hover:bg-gray-50">
                        <td className="px-3 py-3 text-xs text-gray-900">
                          {transportMethodsIndexOfFirstItem + index + 1}
                        </td>
                        <td className="px-3 py-3 text-xs">
                          <div className="flex gap-2">
                            <button
                              onClick={() =>
                                transportMethodHandlers.handleViewDetail(
                                  item.name
                                )
                              }
                              className="text-blue-500 hover:text-blue-700"
                            ...
                            <button
                              onClick={() =>
                                transportMethodHandlers.handleDelete(
                                  item.id,
                                  item.name
                                )
                              }
                ...
                <div className="bg-gray-50 px-4 py-3 border-t">
                  <div className="flex items-center justify-between">
                    <div className="text-sm text-gray-700">
                      Hiển thị {transportMethodsIndexOfFirstItem + 1}-
                      {Math.min(
                        transportMethodsIndexOfLastItem,
                        filteredTransportMethodsList.length
                      )}{" "}
                      của {filteredTransportMethodsList.length} bản ghi
                    </div>
                    <div className="flex space-x-1">
                      <button
                        onClick={handlePrevPage}
                      ...
                      {[...Array(transportMethodsTotalPages)].map(
                        (_, index) => {
                          const pageNumber = index + 1;
                          return (
                            <button
            ...
            {showAddTransportMethodModal && (
              <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
                <div className="bg-white rounded-lg p-6 w-1/2 max-h-[90vh] overflow-y-auto">
                  ...
                  <form
                    onSubmit={transportMethodHandlers.handleSubmit}
                    className="space-y-4"
                  >
                    <div className="flex items-center gap-4">
                      <label className="text-sm font-medium text-gray-700 w-1/4">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          transportMethodHandlers.handleFormChange(
                            "code",
                            e.target.value
                          )
                        }
                    ...
                    <div className="flex justify-end space-x-3 pt-6 border-t">
                      <button
                        type="button"
                        onClick={transportMethodHandlers.handleClose}
                        className="px-4 py-2 text-gray-600 border border-gray-300 rounded hover:bg-gray-50"
                      >
                        Đóng
                      </button>
      ...
      case "/system/receipt-templates":
        const receiptTemplatesTotalPages = Math.ceil(
          filteredReceiptTemplatesList.length / itemsPerPage
        );
        const receiptTemplatesIndexOfLastItem = currentPage * itemsPerPage;
        const receiptTemplatesIndexOfFirstItem =
          receiptTemplatesIndexOfLastItem - itemsPerPage;
        const currentReceiptTemplates = filteredReceiptTemplatesList.slice(
          receiptTemplatesIndexOfFirstItem,
          receiptTemplatesIndexOfLastItem
        );

        // Danh sách điểm thu phí cho dropdown
        const diemThuPhiOptions = [
          ...new Set(receiptTemplatesList.map((item) => item.diemThuPhi)),
        ].sort();
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <div className="px-4 py-3 border-b">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-3">
                    <div className="text-sm text-gray-700">
                      Có {filteredReceiptTemplatesList.length}/
                      {receiptTemplatesList.length} bản ghi - Trang:{" "}
                      {currentPage}/{receiptTemplatesTotalPages}
                    </div>
                    <select
                      value={receiptTemplateSearchDiemThu}
                      onChange={(e) =>
                        handleReceiptTemplateSearchDiemThu(e.target.value)
                      }
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleReceiptTemplateSearchCode(e.target.value)
                      }
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleReceiptTemplateSearchKyHieu(e.target.value)
                      }
                      className="border border-gray-300 rounded px-3 py-2 text-sm w-32"
                    />
                    <button
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <div className="overflow-x-auto">
                <table className="w-full">
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {currentReceiptTemplates.map((item, index) => (
                      <tr key={item.id} className="hover:bg-gray-50">
                        <td className="px-3 py-3 text-xs text-gray-900">
                          {receiptTemplatesIndexOfFirstItem + index + 1}
                        </td>
                        <td className="px-3 py-3 text-xs">
                          <div className="flex gap-2">
                            <button
                              onClick={() =>
                                receiptTemplateHandlers.handleViewDetail(
                                  item.mauBL
                                )
                              }
                              className="text-blue-500 hover:text-blue-700"
                            ...
                            <button
                              onClick={() =>
                                receiptTemplateHandlers.handleDelete(
                                  item.id,
                                  item.mauBL
                                )
                              }
                ...
                <div className="bg-gray-50 px-4 py-3 border-t">
                  <div className="flex items-center justify-between">
                    <div className="text-sm text-gray-700">
                      Hiển thị {receiptTemplatesIndexOfFirstItem + 1}-
                      {Math.min(
                        receiptTemplatesIndexOfLastItem,
                        filteredReceiptTemplatesList.length
                      )}{" "}
                      của {filteredReceiptTemplatesList.length} bản ghi
                    </div>
                    <div className="flex space-x-1">
                      <button
                        onClick={handlePrevPage}
                      ...
                      {[...Array(receiptTemplatesTotalPages)].map(
                        (_, index) => {
                          const pageNumber = index + 1;
                          return (
                            <button
              ...
              <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
                <div className="bg-white rounded-lg p-8 w-[900px] max-h-[90vh] overflow-y-auto">
                  <h2 className="text-xl font-bold text-gray-800 mb-8">
                    Cập nhật mẫu - ký hiệu biên lai [Thêm mới]
                  </h2>

                  <form
                    onSubmit={receiptTemplateHandlers.handleSubmit}
                    className="space-y-6"
                  >
                    ...
                    <div className="grid grid-cols-2 gap-6">
                      <div className="flex items-center gap-4">
                        <label className="text-sm font-medium text-gray-700 w-24">
                          Mẫu BL<span className="text-red-500">*</span>
                        </label>
                        <input
                          type="text"
                          value={receiptTemplateFormData.mauBL}
                          onChange={(e) =>
                            receiptTemplateHandlers.handleFormChange(
                              "mauBL",
                              e.target.value
                            )
                          }
                      ...
                      <div className="flex items-center gap-4">
                        <label className="text-sm font-medium text-gray-700 w-24">
                          Ký hiệu BL<span className="text-red-500">*</span>
                        </label>
                        <input
                          type="text"
                    ...
                    <div className="flex items-center gap-4">
                      <label className="text-sm font-medium text-gray-700 w-28">
                        Điểm thu phí<span className="text-red-500">*</span>
                      </label>
                      <select
                        ...
                        <div className="flex items-center gap-4">
                          <label className="flex items-center gap-2">
                            <input
                              ...
                              checked={
                                receiptTemplateFormData.phatHanh ===
                                "Chưa phát hành"
                              }
                              onChange={(e) =>
                                receiptTemplateHandlers.handleFormChange(
                    ...
                    <div className="flex justify-end space-x-4 pt-8 border-t mt-6">
                      ...
                      <button
                        type="button"
                        onClick={receiptTemplateHandlers.handleClose}
                        className="px-8 py-3 text-gray-600 border border-gray-300 rounded hover:bg-gray-50 font-medium"
                      >
                        Đóng
                      </button>
                    </div>
      ...
      case "/system/tariff-types":
        console.log(
          "📋 Rendering tariff-types page with data:",
          tariffTypesList
        );
        return generateCatalogPage({
      ...
      case "/system/tariffs":
        ...
        const currentTariffs = tariffsList.slice(
          tariffsIndexOfFirstItem,
          tariffsIndexOfLastItem
        );

        // Danh sách biểu cước cho dropdown (sử dụng legacy fields nếu có)
        const bieuCuocOptions = [
          ...new Set(
            tariffsList.map((item) => item.bieuCuoc || "").filter(Boolean)
          ),
        ].sort();
        const bieuCuocThueOptions = [
          ...new Set(
            tariffsList.map((item) => item.bieuCuocThue || "").filter(Boolean)
          ),
        ].sort();
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <div className="px-4 py-3 border-b">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-3">
                    <div className="text-sm text-gray-700">
                      Có {tariffsList.length} bản ghi - Trang: {currentPage}/
                      {tariffsTotalPages}
                    </div>
                    <select
                      value={tariffSearchBieuCuoc}
                      onChange={(e) =>
                        handleTariffSearchBieuCuoc(e.target.value)
                      }
                      className="border border-gray-300 rounded px-3 py-2 text-sm w-40"
                    >
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        handleTariffSearchBieuCuocThue(e.target.value)
                      }
                      className="border border-gray-300 rounded px-3 py-2 text-sm w-40"
                    >
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleTariffSearchMaBieuCuoc(e.target.value)
                      }
                      className="border border-gray-300 rounded px-3 py-2 text-sm w-32"
                    />
                    <input
                      ...
                      onChange={(e) =>
                        handleTariffSearchTenBieuCuoc(e.target.value)
                      }
                      className="border border-gray-300 rounded px-3 py-2 text-sm w-32"
                    />
                    <button
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <div className="overflow-x-auto">
                <table className="w-full">
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {currentTariffs.map((item, index) => (
                      <tr key={item.id} className="hover:bg-gray-50">
                        <td className="px-3 py-3 text-xs text-gray-900">
                          {tariffsIndexOfFirstItem + index + 1}
                        </td>
                        <td className="px-3 py-3 text-xs">
                          <div className="flex gap-2">
                            <button
                              onClick={() =>
                                tariffHandlers.handleViewDetail(
                                  item.tenBieuCuoc || item.maBieuCuoc || ""
                                )
                              }
                              className="text-blue-500 hover:text-blue-700"
                              title="Xem chi tiết"
                ...
                <div className="bg-gray-50 px-4 py-3 border-t">
                  <div className="flex items-center justify-between">
                    <div className="text-sm text-gray-700">
                      Hiển thị {tariffsIndexOfFirstItem + 1}-
                      {Math.min(tariffsIndexOfLastItem, tariffsList.length)} của{" "}
                      {tariffsList.length} bản ghi
                    </div>
                    <div className="flex space-x-1">
                      <button
                        onClick={handlePrevPage}
            ...
            {showAddTariffModal && (
              <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
                <div className="bg-white rounded-lg p-8 w-[600px] max-h-[90vh] overflow-y-auto">
                  <h2 className="text-xl font-bold text-gray-800 mb-8">
                    Cập nhật thông tin biểu cước
                  </h2>

                  <form
                    onSubmit={tariffHandlers.handleSubmit}
                    className="space-y-4"
                  >
                    {/* Mã biểu cước */}
                    <div className="flex items-center gap-4">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          tariffHandlers.handleFormChange(
                            "maBieuCuoc",
                            e.target.value
                          )
                        }
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          tariffHandlers.handleFormChange("stt", e.target.value)
                        }
                        className="flex-1 border border-gray-300 rounded px-3 py-2 focus:outline-none focus:border-blue-500"
                        placeholder=""
                      />
                    ...
                    <div className="flex justify-end space-x-4 pt-8 border-t mt-6">
                      ...
                      <button
                        type="button"
                        onClick={tariffHandlers.handleClose}
                        className="px-8 py-3 text-gray-600 border border-gray-300 rounded hover:bg-gray-50 font-medium"
                      >
                        Đóng
                      </button>
      ...
      case "/system/form-types":
        const formTypesTotalPages = Math.ceil(
          filteredFormTypesList.length / itemsPerPage
        );
        const formTypesIndexOfLastItem = currentPage * itemsPerPage;
        const formTypesIndexOfFirstItem =
          formTypesIndexOfLastItem - itemsPerPage;
        const currentFormTypes = filteredFormTypesList.slice(
          formTypesIndexOfFirstItem,
          formTypesIndexOfLastItem
        );

        // Danh sách nhóm loại hình cho dropdown
        const nhomLoaiHinhOptions = [
          ...new Set(formTypesList.map((item) => item.nhomLoaiHinh)),
        ].sort();
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <div className="px-4 py-3 border-b">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-3">
                    <div className="text-sm text-gray-700">
                      Có {filteredFormTypesList.length}/{formTypesList.length}{" "}
                      bản ghi - Trang: {currentPage}/{formTypesTotalPages}
                    </div>
                    <select
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <div className="overflow-x-auto">
                <table className="w-full">
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {currentFormTypes.map((item, index) => (
                      <tr key={item.id} className="hover:bg-gray-50">
                        <td className="px-3 py-3 text-xs text-gray-900">
                          {formTypesIndexOfFirstItem + index + 1}
                        </td>
                        <td className="px-3 py-3 text-xs">
                          <div className="flex gap-2">
                            <button
                              onClick={() =>
                                formTypeHandlers.handleViewDetail(
                                  item.tenLoaiHinh
                                )
                              }
                              className="text-blue-500 hover:text-blue-700"
                ...
                <div className="bg-gray-50 px-4 py-3 border-t">
                  <div className="flex items-center justify-between">
                    <div className="text-sm text-gray-700">
                      Hiển thị {formTypesIndexOfFirstItem + 1}-
                      {Math.min(
                        formTypesIndexOfLastItem,
                        filteredFormTypesList.length
                      )}{" "}
                      của {filteredFormTypesList.length} bản ghi
                    </div>
                    <div className="flex space-x-1">
                      <button
                        onClick={handlePrevPage}
                      ...
                      <button
                        ...
                        className={`px-2 py-1 text-xs border border-gray-300 rounded hover:bg-gray-100 ${
                          currentPage === formTypesTotalPages
                            ? "opacity-50 cursor-not-allowed"
                            : ""
                        }`}
                      >
            ...
            {showAddFormTypeModal && (
              <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
                <div className="bg-white rounded-lg p-8 w-[600px] max-h-[90vh] overflow-y-auto">
                  <h2 className="text-xl font-bold text-gray-800 mb-8">
                    Cập nhật thông tin loại hình
                  </h2>

                  <form
                    onSubmit={formTypeHandlers.handleSubmit}
                    className="space-y-4"
                  >
                    {/* Nhóm LH */}
                    <div className="flex items-center gap-4">
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          formTypeHandlers.handleFormChange(
                            "nhomLoaiHinh",
                            e.target.value
                          )
                        }
                    ...
                    <div className="flex justify-end space-x-4 pt-8 border-t mt-6">
                      ...
                      <button
                        type="button"
                        onClick={formTypeHandlers.handleClose}
                        className="px-8 py-3 text-gray-600 border border-gray-300 rounded hover:bg-gray-50 font-medium"
                      >
                        Đóng
                      </button>
      ...
      case "/system/payment-types":
        const paymentTypesTotalPages = Math.ceil(
          filteredPaymentTypesList.length / itemsPerPage
        );
        const paymentTypesIndexOfLastItem = currentPage * itemsPerPage;
        const paymentTypesIndexOfFirstItem =
          paymentTypesIndexOfLastItem - itemsPerPage;
        const currentPaymentTypes = filteredPaymentTypesList.slice(
          paymentTypesIndexOfFirstItem,
          paymentTypesIndexOfLastItem
        );
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <div className="px-4 py-3 border-b">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-3">
                    <div className="text-sm text-gray-700">
                      Có {filteredPaymentTypesList.length}/
                      {paymentTypesList.length} bản ghi - Trang: {currentPage}/
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handlePaymentTypeSearchMa(e.target.value)
                      }
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handlePaymentTypeSearchTen(e.target.value)
                      }
                      className="border border-gray-300 rounded px-3 py-2 text-sm w-36"
                    />
                    <button
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <div className="overflow-x-auto">
                <table className="w-full">
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {currentPaymentTypes.map((item, index) => (
                      <tr key={item.id} className="hover:bg-gray-50">
                        <td className="px-3 py-3 text-xs text-gray-900">
                          {paymentTypesIndexOfFirstItem + index + 1}
                        </td>
                        <td className="px-3 py-3 text-xs">
                          <div className="flex gap-2">
                            <button
                              onClick={() =>
                                paymentTypeHandlers.handleViewDetail(
                                  item.tenLoaiThanhToan
                                )
                              }
                              className="text-blue-500 hover:text-blue-700"
                            ...
                            <button
                              onClick={() =>
                                paymentTypeHandlers.handleDelete(
                                  item.id,
                                  item.tenLoaiThanhToan
                                )
                              }
                ...
                <div className="bg-gray-50 px-4 py-3 border-t">
                  <div className="flex items-center justify-between">
                    <div className="text-sm text-gray-700">
                      Hiển thị {paymentTypesIndexOfFirstItem + 1}-
                      {Math.min(
                        paymentTypesIndexOfLastItem,
                        filteredPaymentTypesList.length
                      )}{" "}
                      của {filteredPaymentTypesList.length} bản ghi
                    </div>
                    <div className="flex space-x-1">
                      <button
                        onClick={handlePrevPage}
                      ...
                      <button
                        ...
                        className={`px-2 py-1 text-xs border border-gray-300 rounded hover:bg-gray-100 ${
                          currentPage === paymentTypesTotalPages
                            ? "opacity-50 cursor-not-allowed"
                            : ""
                        }`}
                      >
            ...
            {showAddPaymentTypeModal && (
              <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
                <div className="bg-white rounded-lg p-8 w-[600px] max-h-[90vh] overflow-y-auto">
                  <h2 className="text-xl font-bold text-gray-800 mb-8">
                    Cập nhật thông tin loại thanh toán
                  </h2>

                  <form
                    onSubmit={paymentTypeHandlers.handleSubmit}
                    className="space-y-4"
                  >
                    {/* Mã */}
                    <div className="flex items-center gap-4">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          paymentTypeHandlers.handleFormChange(
                            "maLoaiThanhToan",
                            e.target.value
                          )
                        }
                    ...
                    {/* Diễn giải */}
                    <div className="flex gap-4">
                      <label className="text-sm font-medium text-gray-700 w-20 pt-2">
                        Diễn giải:
                      </label>
                      <textarea
                    ...
                    <div className="flex justify-end space-x-4 pt-8 border-t mt-6">
                      ...
                      <button
                        type="button"
                        onClick={paymentTypeHandlers.handleClose}
                        className="px-8 py-3 text-gray-600 border border-gray-300 rounded hover:bg-gray-50 font-medium"
                      >
                        Đóng
                      </button>
      ...
      case "/system/container-types":
        const containerTypesTotalPages = Math.ceil(
          filteredContainerTypesList.length / itemsPerPage
        );
        const containerTypesIndexOfLastItem = currentPage * itemsPerPage;
        const containerTypesIndexOfFirstItem =
          containerTypesIndexOfLastItem - itemsPerPage;
        const currentContainerTypes = filteredContainerTypesList.slice(
          containerTypesIndexOfFirstItem,
          containerTypesIndexOfLastItem
        );
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <div className="px-4 py-3 border-b">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-3">
                    <div className="text-sm text-gray-700">
                      Có {filteredContainerTypesList.length}/
                      {containerTypesList.length} bản ghi - Trang: {currentPage}
                      /{containerTypesTotalPages}
                    </div>
                    <input
                      type="text"
                      ...
                      onChange={(e) =>
                        handleContainerTypeSearchMa(e.target.value)
                      }
                      className="border border-gray-300 rounded px-3 py-2 text-sm w-32"
                    />
                    <input
                      ...
                      onChange={(e) =>
                        handleContainerTypeSearchTen(e.target.value)
                      }
                      className="border border-gray-300 rounded px-3 py-2 text-sm w-32"
                    />
                    <button
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <div className="overflow-x-auto">
                <table className="w-full">
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {currentContainerTypes.map((item, index) => (
                      <tr key={item.id} className="hover:bg-gray-50">
                        <td className="px-3 py-3 text-xs text-gray-900">
                          {containerTypesIndexOfFirstItem + index + 1}
                        </td>
                        <td className="px-3 py-3 text-xs">
                          <div className="flex gap-2">
                            <button
                              onClick={() =>
                                containerTypeHandlers.handleViewDetail(
                                  item.tenLoaiContainer
                                )
                              }
                              className="text-blue-500 hover:text-blue-700"
                            ...
                            <button
                              onClick={() =>
                                containerTypeHandlers.handleDelete(
                                  item.id,
                                  item.tenLoaiContainer
                                )
                              }
                ...
                <div className="bg-gray-50 px-4 py-3 border-t">
                  <div className="flex items-center justify-between">
                    <div className="text-sm text-gray-700">
                      Hiển thị {containerTypesIndexOfFirstItem + 1}-
                      {Math.min(
                        containerTypesIndexOfLastItem,
                        filteredContainerTypesList.length
                      )}{" "}
                      của {filteredContainerTypesList.length} bản ghi
                    </div>
                    <div className="flex space-x-1">
                      <button
                        onClick={handlePrevPage}
                      ...
                      <button
                        ...
                        className={`px-2 py-1 text-xs border border-gray-300 rounded hover:bg-gray-100 ${
                          currentPage === containerTypesTotalPages
                            ? "opacity-50 cursor-not-allowed"
                            : ""
                        }`}
                      >
            ...
            {showAddContainerTypeModal && (
              <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
                <div className="bg-white rounded-lg p-8 w-[600px] max-h-[90vh] overflow-y-auto">
                  ...
                  <form
                    onSubmit={containerTypeHandlers.handleSubmit}
                    className="space-y-4"
                  >
                    {/* Mã */}
                    <div className="flex items-center gap-3">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          containerTypeHandlers.handleFormChange(
                            "maLoaiContainer",
                            e.target.value
                          )
                        }
                    ...
                    <div className="flex justify-end space-x-4 pt-8 border-t mt-6">
                      ...
                      <button
                        type="button"
                        onClick={containerTypeHandlers.handleClose}
                        className="px-8 py-3 text-gray-600 border border-gray-300 rounded hover:bg-gray-50 font-medium"
                      >
                        Đóng
                      </button>
      ...
      case "/system/units":
        const unitsTotalPages = Math.ceil(
          filteredUnitsList.length / itemsPerPage
        );
        const unitsIndexOfLastItem = currentPage * itemsPerPage;
        const unitsIndexOfFirstItem = unitsIndexOfLastItem - itemsPerPage;
        const currentUnits = filteredUnitsList.slice(
          unitsIndexOfFirstItem,
          unitsIndexOfLastItem
        );

        // Danh sách loại đơn vị tính cho dropdown
        const loaiDonViTinhOptions = [
          ...new Set(unitsList.map((item) => item.loaiDonViTinh)),
        ].sort();
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <div className="px-4 py-3 border-b">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-3">
                    <div className="text-sm text-gray-700">
                      Có {filteredUnitsList.length}/{unitsList.length} bản ghi -
                      Trang: {currentPage}/{unitsTotalPages}
                    </div>
                    <select
                      value={unitSearchDonViTinh}
                      onChange={(e) =>
                        handleUnitSearchDonViTinh(e.target.value)
                      }
                      className="border border-gray-300 rounded px-3 py-2 text-sm w-32"
                    >
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <div className="overflow-x-auto">
                <table className="w-full">
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {currentUnits.map((item, index) => (
                      <tr key={item.id} className="hover:bg-gray-50">
                        <td className="px-3 py-3 text-xs text-gray-900">
                          {unitsIndexOfFirstItem + index + 1}
                        </td>
                        <td className="px-3 py-3 text-xs">
                          <div className="flex gap-2">
                            <button
                              onClick={() =>
                                unitHandlers.handleViewDetail(item.tenDonViTinh)
                              }
                              className="text-blue-500 hover:text-blue-700"
                              title="Xem chi tiết"
                            >
                ...
                <div className="bg-gray-50 px-4 py-3 border-t">
                  <div className="flex items-center justify-between">
                    <div className="text-sm text-gray-700">
                      Hiển thị {unitsIndexOfFirstItem + 1}-
                      {Math.min(unitsIndexOfLastItem, filteredUnitsList.length)}{" "}
                      của {filteredUnitsList.length} bản ghi
                    </div>
                    <div className="flex space-x-1">
                      <button
                        onClick={handlePrevPage}
            ...
            {showAddUnitModal && (
              <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
                <div className="bg-white rounded-lg p-8 w-[600px] max-h-[90vh] overflow-y-auto">
                  ...
                  <form
                    onSubmit={unitHandlers.handleSubmit}
                    className="space-y-4"
                  >
                    {/* Mã ĐVT */}
                    <div className="flex items-center gap-3">
                    ...
                    <div className="flex justify-end space-x-4 pt-8 border-t mt-6">
                      ...
                      <button
                        type="button"
                        onClick={unitHandlers.handleClose}
                        className="px-8 py-3 text-gray-600 border border-gray-300 rounded hover:bg-gray-50 font-medium"
                      >
                        Đóng
                      </button>
        ...
        return (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="bg-white p-4 rounded-lg shadow border-l-4 border-blue-500">
              ...
              <p className="text-sm text-gray-600 mt-2">
                Quản lý thông tin và cài đặt doanh nghiệp
              </p>
            </div>
            ...
            <div className="bg-white p-4 rounded-lg shadow border-l-4 border-purple-500">
              ...
              <p className="text-sm text-gray-600 mt-2">
                Quản lý danh sách chi cục hải quan
              </p>
            </div>
            <div className="bg-white p-4 rounded-lg shadow border-l-4 border-red-500">
              ...
              <p className="text-sm text-gray-600 mt-2">
                Quản lý danh sách ngân hàng thương mại
              </p>
            </div>
            <div className="bg-white p-4 rounded-lg shadow border-l-4 border-indigo-500">
              <h3 className="font-semibold text-gray-800">
                Danh mục Kho/Bãi/Cảng
              </h3>
              <p className="text-sm text-gray-600 mt-2">
                Quản lý danh sách kho bãi cảng
              </p>
            </div>
            <div className="bg-white p-4 rounded-lg shadow border-l-4 border-pink-500">
              <h3 className="font-semibold text-gray-800">
                Danh mục trạm thu phí
              </h3>
              <p className="text-sm text-gray-600 mt-2">
                Quản lý danh sách trạm thu phí
              </p>
            </div>
            <div className="bg-white p-4 rounded-lg shadow border-l-4 border-orange-500">
              <h3 className="font-semibold text-gray-800">
                Danh mục địa điểm lưu kho
              </h3>
              <p className="text-sm text-gray-600 mt-2">
                Quản lý địa điểm lưu kho
              </p>
            </div>
            ...
            <div className="bg-white p-4 rounded-lg shadow border-l-4 border-emerald-500">
              <h3 className="font-semibold text-gray-800">
                Danh mục mẫu ký hiệu biên lai
              </h3>
              <p className="text-sm text-gray-600 mt-2">
                Quản lý mẫu ký hiệu biên lai
              </p>
            </div>
    ...
    <>
      {isFullWidthPage ? (
        ...
        <div className="h-full">
              ...
              <i
                className={`${
                  location.pathname === "/system/users"
                    ? "fas fa-users"
                    : location.pathname === "/system/business"
                    ? "fas fa-building"
                    : location.pathname === "/system/customs"
                    ? "fas fa-ship"
                    : location.pathname === "/system/banks"
                    ? "fas fa-university"
                    : location.pathname === "/system/warehouses"
                    ? "fas fa-warehouse"
                    : location.pathname === "/system/toll-stations"
                    ? "fas fa-road"
                    : location.pathname === "/system/storage-locations"
                    ? "fas fa-map-marker"
                    : location.pathname === "/system/enterprises"
                    ? "fas fa-industry"
                    : location.pathname === "/system/transport-methods"
                    ? "fas fa-truck"
                    : location.pathname === "/system/receipt-templates"
                    ? "fas fa-receipt"
                    : location.pathname === "/system/tariff-types"
                    ? "fas fa-tags"
                    : location.pathname === "/system/tariffs"
                    ? "fas fa-money-bill"
                    : location.pathname === "/system/form-types"
                    ? "fas fa-file-alt"
                    : location.pathname === "/system/payment-types"
                    ? "fas fa-credit-card"
                    : location.pathname === "/system/container-types"
                    ? "fas fa-box"
                    : location.pathname === "/system/units"
                    ? "fas fa-calculator"
                    : "fas fa-cogs"
                } text-blue-500 mr-3`}
              ></i>
          ...
          <div className="p-4">{getPageContent()}</div>
        </div>
      ) : (
          ...
          <div className="bg-white rounded-lg p-6 w-4/5 max-w-4xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="flex justify-between items-center mb-6 pb-4 border-b">
              <h2 className="text-xl font-bold text-gray-800">
                ...
                Quản lý quyền: {selectedUser.fullname} ({selectedUser.username})
              </h2>
              <button
            ...
            <div className="mb-6 p-4 bg-gray-50 rounded-lg">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-900">{selectedUser.groupName}</p>
                </div>
                <div>
                  <label className="text-sm font-medium text-gray-700">
                    ID Nhóm:
                  </label>
                  <p className="text-gray-900">{selectedUser.groupId}</p>
                </div>
              </div>
            </div>
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-lg font-semibold text-gray-800">
                  ...
                  Quyền của nhóm ({userGroupPermissions.length} chức năng)
                </h3>
                <div className="text-sm text-gray-500">
                  <i className="fas fa-info-circle mr-1"></i>
                  Toggle để tắt/bật chức năng cho user này
                </div>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                {userGroupPermissions.map((permission) => {
                  const isDisabled = userDisabledFeatures.some(
                    (f) => f.funcId === permission.funcId
                  );

                  return (
                    <div
                      key={permission.funcId}
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          >
                            {isDisabled ? (
                              <>
                                <i className="fas fa-ban mr-1"></i>Bị tắt
                              </>
                            ) : (
                              <>
                                <i className="fas fa-check mr-1"></i>Hoạt động
                              </>
                            )}
                          </span>
                        </div>
