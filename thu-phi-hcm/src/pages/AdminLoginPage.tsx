          ...
          >
            ...
            <div style={{ padding: "20px" }}>
              ...
              <div style={{ marginBottom: "16px" }}>
                ...
                >
                  <option>
                    KHÔI PHỤC TÀI KHOẢN ADMIN THÔNG QUA EMAIL ĐÃ ĐĂNG KÝ
                  </option>
                </select>
              </div>
              ...
              >
                Vui lòng điền Mã quản trị và Email đã đăng ký. Hệ thống sẽ gửi
            ...
            <div style={{ padding: "20px" }}>
              <form onSubmit={handleRegisterSubmit}>
                ...
                >
                  ...
                  >
                    - Tài khoản Admin có quyền quản trị toàn bộ hệ thống. Vui
                    lòng cung cấp đầy đủ, chính xác các thông tin theo yêu cầu.
                  </div>
                  <div
                    style={{
                      fontSize: "13px",
